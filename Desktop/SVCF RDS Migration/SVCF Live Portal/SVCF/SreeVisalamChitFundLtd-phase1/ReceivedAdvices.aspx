<%@ Page Language="C#" Culture="en-GB" MasterPageFile="~/Branch.Master" AutoEventWireup="true" CodeBehind="ReceivedAdvices.aspx.cs"
                    ...
                    <div class="row">
                        <table class="aligned" style="margin: 0px auto;">
                            <tr>
                                ...
                                <td style="padding-right:5px;">
                                    <asp:DropDownList Width="200" ID="ddlStatus" runat="server" CssClass="chzn-select" AutoPostBack="true" OnSelectedIndexChanged="ddlStatus_SelectedIndexChanged">
                    ...
                    <div class="twelve columns centered">
                        ...
                        <br />
                            <asp:GridView CssClass="aspxtable" ID="GridView1" runat="server" AutoGenerateColumns="false"
                                GridLines="None" DataKeyNames="DualTransactionKey,ChoosenDate,ReceiptNumber,Series,MemberID,ChitGroupID,CollectedBranchID,Token,Description,Amount,TransactionKey,BranchName,AppReceiptno"
