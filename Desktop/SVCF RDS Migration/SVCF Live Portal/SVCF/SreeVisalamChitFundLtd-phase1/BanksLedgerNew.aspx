<%@ Page Culture="en-GB" Title="SVCF Admin Panel" Language="C#" AutoEventWireup="true"
    CodeBehind="BanksLedgerNew.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.BanksLedgerNew" %>
...
<body>
    ...
    <div style="margin-top: -0.5em; margin-bottom: 0.6em;" class="Sub-heading">
        ...
        <div style="display: table-cell; vertical-align: top; padding-top: 5px; padding-right: 5px !important;">
            <asp:TextBox class="input-text maskdate" Width="80px" ID="txtFromDate" runat="server"
        ...
        <div style="display: table-cell; vertical-align: top; padding-top: 5px; padding-right: 5px !important;">
            <asp:TextBox class="input-text maskdate" Width="80px" ID="txtToDate" placeholder="To Date"
        ...
        <div style="display: table-cell; vertical-align: top; padding-top: 4px; padding-right: 5px !important;">
            <asp:DropDownList ID="ddlGroup" Width="150px" CssClass="chzn-select" AutoPostBack="true"
                ...
                <asp:ListItem Text="Bank and Date" Value="Bank and Date"></asp:ListItem>
                <asp:ListItem Text="Bank Alone" Value="Bank Alone"></asp:ListItem>
            </asp:DropDownList>
        </div>
    ...
    <dx:ASPxGridView Style="margin: 0 auto; width: 100%;" OnSummaryDisplayText="ASPxGridView1_SummaryDisplayText"
        ...
        runat="server" DataSourceID="AccessDataSource1" OnCustomCallback="grid_CustomCallback">
        <Settings  GroupFormat="{1}{2}" VerticalScrollableHeight="275" ShowTitlePanel="true"
        ...
        <GroupSummary>
            ...
            <dx:ASPxSummaryItem FieldName="Bank" ShowInGroupFooterColumn="Debit" SummaryType="Custom" />
            <dx:ASPxSummaryItem FieldName="CustomersBank" ShowInGroupFooterColumn="Credit" SummaryType="Custom" />
        </GroupSummary>
        <TotalSummary>
        ...
        <Columns>
            ...
            <dx:GridViewDataColumn FieldName="LedgerHead" CellStyle-HorizontalAlign="Left">
            </dx:GridViewDataColumn>
            <dx:GridViewDataColumn FieldName="Bank" CellStyle-HorizontalAlign="Left">
            </dx:GridViewDataColumn>
            <dx:GridViewDataColumn FieldName="AccountNo." Caption="Account Number" CellStyle-HorizontalAlign="Left">
            </dx:GridViewDataColumn>
            <dx:GridViewDataColumn FieldName="CustomersBank" CellStyle-HorizontalAlign="Left">
            </dx:GridViewDataColumn>
            <dx:GridViewDataColumn FieldName="ChequeNo." Caption="Cheque Number" CellStyle-HorizontalAlign="Left">
            </dx:GridViewDataColumn>
            <dx:GridViewDataColumn FieldName="Narration" FooterCellStyle-Wrap="True" CellStyle-HorizontalAlign="Left" FooterCellStyle-HorizontalAlign="Left">
            </dx:GridViewDataColumn>
            <dx:GridViewDataColumn FieldName="Credit" FooterCellStyle-Wrap="True"  CellStyle-HorizontalAlign="Right" GroupFooterCellStyle-HorizontalAlign="Right" FooterCellStyle-HorizontalAlign="Right">
            </dx:GridViewDataColumn>
            <dx:GridViewDataColumn FieldName="Debit" FooterCellStyle-Wrap="True"  CellStyle-HorizontalAlign="Right"  GroupFooterCellStyle-HorizontalAlign="Right" FooterCellStyle-HorizontalAlign="Right">
            </dx:GridViewDataColumn>
        </Columns>
        <Styles GroupFooter-HorizontalAlign="Right" Footer-HorizontalAlign="Left" Cell-HorizontalAlign="Right"
    ...
    <dx:ASPxGridViewExporter ID="gridExport" runat="server" GridViewID="grid">
        <Styles>
            ...
            <Cell Font-Size="6" HorizontalAlign="Left" Wrap="True">
            </Cell>
            <Footer Font-Size="7" HorizontalAlign="Left" Wrap="True">
            </Footer>
