<%@ Page Language="C#" AutoEventWireup="true" Culture="en-GB" MasterPageFile="~/Branch.Master"
    CodeBehind="CRRApply.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.CRRApply" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
                ...
                <div class="box_c_content">
                    <div class="noprint" style="margin-top: -0.5em; margin-bottom: 0.6em;">
                        ...
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="BtnStatisticsGo">
                                     ...
                                     <tr>
                                         <td>
                                             <asp:UpdatePanel ID="upanel1" runat="server">
                                                 <ContentTemplate>                                                                                                      
                                             <asp:RadioButtonList ID="RadList" runat="server" OnSelectedIndexChanged="RadList_SelectedIndexChanged" RepeatDirection="Horizontal">
                            ...
                            <div style="display: table-cell; padding-right: 5px;">
                                ...
                                <asp:RequiredFieldValidator ValidationGroup="twelvehead" Display="Dynamic" ID="RequiredFieldValidator2"
                                    runat="server" ErrorMessage="" ControlToValidate="txtFromDate"></asp:RequiredFieldValidator>
                                <asp:CompareValidator ID="CompareValidator1" runat="server" ValidationGroup="twelvehead"
                            ...
                            <div style="display: table-cell; padding-right: 5px; vertical-align: top;">
                                <asp:Button ValidationGroup="twelvehead" TabIndex="3" ID="BtnStatisticsGo" CssClass="GreenyPushButton"
                                    runat="server" Text="Go!" class="btn" OnClick="BtnStatisticsGo_Click" />
                            </div>
                            <div style="display: table-cell; padding-right: 5px; vertical-align: top;">
                    ...
                    <div id="printdiv" class="printable" runat="server">
                        ...
                        <dx:ASPxGridView Style="margin: 0 auto; width: 100%;" ID="grid" runat="server" ClientInstanceName="grid"
                            OnHtmlRowPrepared="grid_HtmlRowPrepared"  ShowSelectCheckbox="true" KeyFieldName="TransactionKey" OnCustomJSProperties="grid_CustomJSProperties">
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataColumn FieldName="TransactionKey" VisibleIndex="2" Width="7%" Caption="TransactionKey">
                                </dx:GridViewDataColumn>
                    ...
                    <div id="apprvdDiv" class="printable" runat="server" visible="false">
                        <dx:ASPxGridView Style="margin: 0 auto; width: 100%;" ID="grid1" runat="server" ClientInstanceName="grid1"
                            KeyFieldName="TransactionKey" OnCustomJSProperties="grid1_CustomJSProperties" OnHtmlRowPrepared="grid1_HtmlRowPrepared">                           
                            <Settings ShowTitlePanel="true" ShowHeaderFilterButton="true" ShowFilterBar="Visible"
                                ShowFilterRow="true" ShowFilterRowMenu="true" />
                            <SettingsText Title="Cash Received Register" />
                            <SettingsPager Mode="ShowAllRecords">
    ...
    <ajax:ModalPopupExtender ID="ModalPopupExtender2" CancelControlID="btnCancelPopup" BackgroundCssClass="modalBackground"
    ...
    <asp:Panel CssClass="raised" ID="Pnlmsg" runat="server" Width="350px"
        ...
        <div class="boxheader">
            <div style="margin: 0 auto;">
                <asp:Button Style="margin: 0 auto" CssClass="GreenyPushButton" ID="btnCancelPopup" runat="server"
