...
{
    public partial class OtherItemsLedgerNew : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                select();
                ApplyLayout(1);
                grid.SettingsText.Title = "Trial Balance of Other Items from " + txtFromDate.Text + " to " + txtToDate.Text;
