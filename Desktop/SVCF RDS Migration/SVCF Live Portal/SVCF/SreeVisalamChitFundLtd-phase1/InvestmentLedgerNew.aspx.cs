...
{
    public partial class InvestmentLedgerNew : System.Web.UI.Page
    {
        ...
        ILog logger = log4net.LogManager.GetLogger(typeof(InvestmentLedgerNew));
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                grid.SettingsText.Title = "Trial Balance of Investments from " + txtFromDate.Text + " to " + txtToDate.Text;
                select();
                ApplyLayout(1);
