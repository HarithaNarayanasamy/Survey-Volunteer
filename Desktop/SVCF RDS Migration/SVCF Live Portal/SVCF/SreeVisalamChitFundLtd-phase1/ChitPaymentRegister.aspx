<%@ Page Culture="en-GB" Language="C#" MasterPageFile="~/Branch.Master" AutoEventWireup="true"
    CodeBehind="ChitPaymentRegister.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.ChitPaymentRegister"
    Title="Chit Payment Register" %>
        ...
        <div class="box_c_content">
            ...
            <div style="width: 100%; margin: 0 auto;">
                <dx:ASPxGridView Styles-AlternatingRow-BackColor="LightGray" Style="margin: 0 auto;
                    ...
                    <Settings ShowTitlePanel="true" ShowHeaderFilterButton="true" ShowHorizontalScrollBar="true"
                    ...
                    <Styles Cell-HorizontalAlign="Left" Header-VerticalAlign="Middle" Header-HorizontalAlign="Center"
                        Header-Wrap="True" />
                    <SettingsText Title="Chit Payment Register" />
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataColumn FieldName="PrizedMoney" Caption="Prized Money">
                        </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn FieldName="FormSentForApprovalOn" Caption="Form Sent For Approval On">
                        </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn FieldName="AOSanctionNoandDate" Caption="AO Sanction No. and Date">
                        </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn FieldName="GuarantorName" Caption="Guarantor Name">
                        </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn FieldName="NextInstalmentNo" Caption="Next Inst. No.">
                        </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn FieldName="NextInstalmentAmount" Caption="Next Inst. Amount">
                        </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn FieldName="CANo" Caption="CA No.">
                        </dx:GridViewDataColumn>
                    </Columns>
