<%@ Page Title="" Culture="en-GB" Language="C#" MasterPageFile="~/Branch.Master" AutoEventWireup="true"
    CodeBehind="CDecree.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.CDecree" %>
                                                        ...
                                                        <table style="border: none;">
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <asp:DropDownList CssClass="chzn-select" Style="width: 250px !important;" 
                                                    ...
                                                    <ItemTemplate>
                                                        <table style="border: none;">
                                                            <tr>
                                                                <td>
                                                                    CC
                                                                    <asp:TextBox Width="100" TabIndex="60" Text='<%#Eval("CC") %>' ValidationGroup="GrpRow"
                                                                        CssClass="twitterStyleTextbox sp_number" ID="txtCC" runat="server">
                                                                    </asp:TextBox>
                                                                    <asp:RequiredFieldValidator Display="Dynamic" ValidationGroup="GrpRow" ControlToValidate="txtCC"
                                                    ...
                                                    <ItemTemplate>
                                                        <table style="border: none;">
                                                            <tr>
                                                                <td>
                                                                    Number
                                                                    <asp:TextBox Width="100" TabIndex="61" Text='<%#Eval("ARC") %>' ValidationGroup="GrpRow"
                                                                        CssClass="twitterStyleTextbox" ID="txtARC" runat="server">
                                                                    </asp:TextBox>
                                                                    <asp:RequiredFieldValidator Display="Dynamic" ValidationGroup="GrpRow" ControlToValidate="txtARC"
