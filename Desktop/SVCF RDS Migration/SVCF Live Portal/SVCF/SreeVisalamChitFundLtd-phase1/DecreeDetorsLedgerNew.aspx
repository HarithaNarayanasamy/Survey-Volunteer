<%@ Page Culture="en-GB" Title="SVCF Admin Panel" Language="C#" AutoEventWireup="true"
    CodeBehind="DecreeDetorsLedgerNew.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.DecreeDetorsLedgerNew" %>
...
<body>
    ...
    <dx:ASPxGridView Style="margin: 0 auto; width: 100%;" OnSummaryDisplayText="ASPxGridView1_SummaryDisplayText"
        ...
        <Columns>
            ...
            <dx:GridViewDataColumn FieldName="Head" CellStyle-HorizontalAlign="Left">
            </dx:GridViewDataColumn>
            <dx:GridViewDataColumn FieldName="Narration" CellStyle-HorizontalAlign="Left" FooterCellStyle-HorizontalAlign="Left" >
            </dx:GridViewDataColumn>
