    ...
    <div class="box_c">
        ...
        <div class="box_c_content">
            ...
            <div style="width: 100%; margin: 0px auto;">
                ...
                <asp:SqlDataSource runat="server" ID="AccessDataSource1" ConnectionString="server=192.168.0.36;database=svcf;pwd=sqlaltius;UID=root;Allow Zero Datetime=true;port=3306;Old Guids=true;pooling=true;Max Pool Size=200"
