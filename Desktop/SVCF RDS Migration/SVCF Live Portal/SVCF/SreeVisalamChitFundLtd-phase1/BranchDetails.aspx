                        ...
                        <asp:Panel DefaultButton="btnAdd" runat="server">
                            <div style="width: 100%;">
                                <table cellspacing="3" style="margin: 0 auto;">
                                    ...
                                    <tr>
                                        <td style="vertical-align: top; padding-top: 6px; padding-right: 6px;">
                                            <asp:Label ID="Label8" runat="server" Text="Branch Prefix"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtBranchPrefix" runat="server" TabIndex="3" placeholder="Branch Prefix" CssClass="input-text ttip_r"></asp:TextBox>
                                            <asp:RequiredFieldValidator ValidationGroup="BranchValid" Display="Dynamic" runat="server"
                                                ControlToValidate="txtBranchPrefix" ErrorMessage="Enter Branch Prefix"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
