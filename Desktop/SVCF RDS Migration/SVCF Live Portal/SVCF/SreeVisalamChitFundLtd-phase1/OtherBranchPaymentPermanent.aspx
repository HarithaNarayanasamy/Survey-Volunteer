<%@ Page Title="SVCF Admin Panel" Culture="en-GB" Language="C#" MasterPageFile="~/Branch.Master"
    AutoEventWireup="true" CodeBehind="OtherBranchPaymentPermanent.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.OtherBranchPaymentPermanent" %>
            ...
            <div class="box_c">
                ...
                <div class="box_c_content">
                                ...
                                <div class="row">
                                    <div style="width: 100%">
                                        <table style="display: table; margin: 0px auto;">
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Label ID="label8" runat="server" Text="Payment On" Visible="False"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtDate" TabIndex="7" CssClass="input-text maskdate" placeholder="Payment Date" Visible="False"
                                                        runat="server">
                                                    </asp:TextBox>
                                                  <%--  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ErrorMessage="Enter Payment Date"
                                                    ...
                                                    <asp:CompareValidator Visible="False" ForeColor="Red" Type="Date" ID="CompareValidator1" ValidationGroup="pa"
                                                    ...
                                                    <asp:RangeValidator ID="rvDate" runat="server"  Type="Date" ControlToValidate="txtDate" ValidationGroup="pa"
                                                        ForeColor="Red" Visible="False" Display="Dynamic" ErrorMessage="*"></asp:RangeValidator>
                                                </td>
                                                <td>
                                                    <asp:Label ID="label13" runat="server" Text="Approved On" Visible="False"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtPaymentonDate" TabIndex="8" CssClass="input-text maskdate" Visible="False"
                                                   ...
                                                   <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ErrorMessage="Enter Payment Date"
                                                    ...
                                                    <asp:CompareValidator ForeColor="Red" Type="Date" ID="CompareValidator2" ValidationGroup="pa"
                                                        ...
                                                        runat="server" Visible="False" ErrorMessage="Incorrect!!!"></asp:CompareValidator>--%>
                                              <%--      <asp:RangeValidator ID="RangeValidator1" runat="server" MaximumValue="31/12/2015"
                                                        MinimumValue="01/01/2013" Type="Date" ControlToValidate="txtPaymentonDate" ValidationGroup="pa"
                                                        ForeColor="Red" Visible="False" Display="Dynamic" ErrorMessage="*"></asp:RangeValidator>--%>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="vertical-align: top; padding-right: 5px; padding-top: 6px;">
                                                    <asp:Label ID="label17" runat="server" Text="Applied On" Visible="False"></asp:Label>
                                                </td>
                                                <td style="vertical-align: top;">
                                                    <asp:TextBox TabIndex="9" ID="txtApplyedOn" CssClass="input-text maskdate" Visible="False"
                                                        placeholder="Applied Date" runat="server">
                                                    </asp:TextBox>
                                                  <%--  <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ErrorMessage="Enter Applied Date"
                                                    ...
                                                    <asp:CompareValidator ForeColor="Red" Type="Date" ID="CompareValidator3" ValidationGroup="pa"
                                                        ControlToValidate="txtApplyedOn" Visible="False" Display="Dynamic" Operator="DataTypeCheck" runat="server"
                                                        ErrorMessage="Incorrect!!!"></asp:CompareValidator>
                                                    <asp:RangeValidator ID="RangeValidator3" runat="server" MaximumValue="31/12/2015"
                                                        MinimumValue="01/01/2013" Type="Date" Visible="False" ControlToValidate="txtApplyedOn" ValidationGroup="pa"
                                                        ForeColor="Red" Display="Dynamic" ErrorMessage="*"></asp:RangeValidator>--%>
                                                </td>
                                                <td style="vertical-align: top; padding-right: 5px; padding-top: 6px;">
                                                    <asp:Label ID="label19" runat="server" Text="Admin Sanction Number" Visible="False"></asp:Label>
                                                </td>
                                                <td style="vertical-align: top;">
                                                    <asp:TextBox TabIndex="10" MaxLength="4" CssClass="input-text sp_number" placeholder="Admin Sanction Number" visible="False"
                                                    ...
                                                    <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator12" ErrorMessage="Enter Admin Sanction Number"
                                                        ControlToValidate="txtAOSanctiion" ValidationGroup="pa"  Visible="False" Display="Dynamic" runat="server"></asp:RequiredFieldValidator>--%>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="label10" runat="server" Text="Guarantor Name" Visible="true"></asp:Label>
                                                </td>
                                                <td>
                                                 <%-- <asp:DropDownList TabIndex="6" Width="240px" CssClass="chzn-select" ID="ddlGuarantor"
                                                        runat="server">
                                                    </asp:DropDownList>
                                                      <asp:CompareValidator ID="CompareValidator15" ValueToCompare="0" ValidationGroup="pa"
                                                        ControlToValidate="ddlGuarantor" Display="Dynamic" Operator="NotEqual" runat="server"
                                                        ErrorMessage="Select Guarantor Name"></asp:CompareValidator>--%>
                                                   <asp:TextBox TabIndex="5" placeholder="Gurantor Name"  CssClass="input-text" Visible="False"
                                                        ID="txtGurantor" runat="server" ></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator15" ErrorMessage="Enter Gurantor Number"
                                                        ControlToValidate="txtGurantor" Visible="False" ValidationGroup="pa" Display="Dynamic" runat="server"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                        </table>
                                        <br />
                                        <table style="display: table; margin: 0px auto;">
                                            ...
                                            <tr>
                                                <td style="padding-right: 5px;padding-top:20px;">
                                                    <asp:Label ID="label1" runat="server" Text="Branch Name & Amount"></asp:Label>
                                                </td>
                                                <td style="padding-right: 5px;">
                                                    <asp:TextBox TabIndex="12" ToolTip="Ex. 1000.00" placeholder="Branch Amount" CssClass="input-text sp_float"
                                                ...
                                                <td>
                                                    <asp:DropDownList TabIndex="13" CssClass="chzn-select" Width="240px" ID="ddlBankName"
                                                        runat="server">
                                                    </asp:DropDownList>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox TabIndex="14" CssClass="input-text sp_float" ToolTip="Ex. 1000.00"
                                            ...
                                            <tr>
                                                <td style="padding-right: 5px;">
                                                    <asp:Label ID="label14" runat="server" Text="GST(Goods and service Tax)"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:TextBox TabIndex="15" CssClass="input-text sp_float" ToolTip="Ex. 1000.00"
                                                        placeholder="GST" ID="txtGST" runat="server"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ControlToValidate="txtGST" Display="Dynamic"
                                                        ValidationGroup="pa" ID="RequiredFieldValidator1" runat="server" ErrorMessage="Enter GST"></asp:RequiredFieldValidator>
                                                </td>
                                                <td>
                                                </td>
                                            </tr>
                                          <%--  <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox TabIndex="16" ToolTip="Ex. 1000.00" CssClass="input-text sp_float"
                                                        placeholder="Service Charge" ID="txtServiceCharge" runat="server"></asp:TextBox>
                                                </td>
                                                <td>
                                                </td>
                                            </tr>--%>
                                            ...
                                            <tr>
                                                <td style="padding-right: 5px;">
                                                    <asp:Label ID="label15" runat="server" Text="Chit Kasar Amount"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:TextBox AutoPostBack="true" TabIndex="18" CssClass="input-text sp_float"
                                                        ToolTip="Ex. 1000.00" placeholder="Chit Kasar Amount" ID="txtChitKasarAmount"
                                                    ...
                                                    <asp:RequiredFieldValidator ControlToValidate="txtChitKasarAmount" Display="Dynamic"
                                                        ValidationGroup="pa" ID="RequiredFieldValidator3" runat="server" ErrorMessage="Enter Chit Kasar Amount"></asp:RequiredFieldValidator>
                                                </td>
                                                <td>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox TabIndex="21" ReadOnly="true" ToolTip="Ex. 1000.00" CssClass="input-text sp_float"
                    ...
                    <div id="Div1" runat="server" style="margin: 0px auto; display: table;">
                        <asp:Button TabIndex="22" CausesValidation="true" ID="btnPayment" runat="server"
                            ValidationGroup="pa" CssClass="GreenyPushButton" OnClick="load_Payment" Text="Payment">
                        </asp:Button>
                        <asp:Button TabIndex="23" CausesValidation="false" ID="Button1" runat="server" CssClass="GreenyPushButton"
