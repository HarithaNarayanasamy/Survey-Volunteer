...
{
    public partial class CashLedgerNew : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                select();
                grid.SettingsText.Title = "Trial Balance of Cash from " + txtFromDate.Text + " to " + txtToDate.Text;
                ApplyLayout(1);
            ...
            if (e.Item.Text.ToString() == "PDF")
            {
                using (this.headerImage = System.Drawing.Image.FromFile(Server.MapPath("~\\Images\\visalam.png")))
                {
                    ...
                    using (MemoryStream stream = new MemoryStream())
                    {
                        ...
                        WriteToResponse("CashLedger", true, "pdf", stream);
                    }
                }
            }
