...
{
    public partial class TopColumnDaybookConsolidatedView : System.Web.UI.Page
    {
        #region Object
        ...
        protected void btnConsolidatedView_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("TopColumnDayBook.aspx?FromDate=" + dateToConsolidated.Text + "");
            }
            else
            {
                Response.Redirect("TopColumnDayBook.aspx");
            }
        }

        protected void grid_AfterPerformCallback(object sender, DevExpress.Web.ASPxGridView.ASPxGridViewAfterPerformCallbackEventArgs e) 
        {
            System.Web.UI.ScriptManager.RegisterClientScriptBlock(Page, typeof(System.Web.UI.Page), "Script", "ResolvePostBack();", true); 
            // System.Web.UI.ScriptManager.RegisterClientScriptBlock(Page, typeof(System.Web.UI.Page), "Script", "__doPostBack('ctl00$cphMainContent$mMain', 'CLICK:0');", true);
        }
        ...
        {
            grid.BeginUpdate();
            gridInvestments.BeginUpdate();
            gridBanks.BeginUpdate();
            gridOtherItems.BeginUpdate();
            gridChits.BeginUpdate();
            gridForemanChits.BeginUpdate();
            gridDecreeDebtors.BeginUpdate();
            gridLoans.BeginUpdate();
            gridSundriesAndAdvances.BeginUpdate();
            gridStamps.BeginUpdate();
            gridProfitAndLoss.BeginUpdate();
            gridCash.BeginUpdate();
            try
            {
                grid.ClearSort();
                gridInvestments.ClearSort();
                gridBanks.ClearSort();
                gridOtherItems.ClearSort();
                gridChits.ClearSort();
                gridForemanChits.ClearSort();
                gridDecreeDebtors.ClearSort();
                gridLoans.ClearSort();
                gridSundriesAndAdvances.ClearSort();
                gridStamps.ClearSort();
                gridProfitAndLoss.ClearSort();
                gridCash.ClearSort();
                switch (layoutIndex)
                {
                    case 0:
                        ...
                        gridInvestments.GroupBy(gridInvestments.Columns["Head"]);
                        gridBanks.GroupBy(gridBanks.Columns["Bank"]);
                        //gridBanks.GroupBy(gridBanks.Columns["Date"]);
                        gridOtherItems.GroupBy(gridOtherItems.Columns["LedgerHead"]);
                        //gridOtherItems.GroupBy(gridOtherItems.Columns["Date"]);
                        //gridChits.GroupBy(gridChits.Columns["Date"]);
                        gridChits.GroupBy(gridChits.Columns["LedgerHead"]);
                        gridChits.GroupBy(gridChits.Columns["Token"]);
                        //gridForemanChits.GroupBy(gridForemanChits.Columns["Date"]);
                        gridForemanChits.GroupBy(gridForemanChits.Columns["Token"]);
                        gridDecreeDebtors.GroupBy(gridDecreeDebtors.Columns["Head"]);
                        gridLoans.GroupBy(gridLoans.Columns["LedgerHead"]);
                        gridSundriesAndAdvances.GroupBy(gridSundriesAndAdvances.Columns["LedgerHead"]);
                        gridStamps.GroupBy(gridStamps.Columns["Date"]);
                        gridProfitAndLoss.GroupBy(gridProfitAndLoss.Columns["LedgerHead"]);
                        //gridCash.GroupBy(gridCash.Columns["Date"]);
                        gridCash.GroupBy(gridCash.Columns["Date"]);
                        grid.EndUpdate();
                        grid.CollapseAll();
                        break;
            ...
            {
                grid.EndUpdate();
                gridInvestments.EndUpdate();
                gridBanks.EndUpdate();
                gridOtherItems.EndUpdate();
                gridChits.EndUpdate();
                gridForemanChits.EndUpdate();
                gridDecreeDebtors.EndUpdate();
                gridLoans.EndUpdate();
                gridSundriesAndAdvances.EndUpdate();
                gridStamps.EndUpdate();
                gridProfitAndLoss.EndUpdate();
                gridCash.EndUpdate();
            }
            grid.CollapseAll();
            gridInvestments.CollapseAll();
            gridBanks.CollapseAll();
            gridOtherItems.CollapseAll();
            gridChits.CollapseAll();
            gridForemanChits.CollapseAll();
            gridDecreeDebtors.CollapseAll();
            gridLoans.CollapseAll();
            gridSundriesAndAdvances.CollapseAll();
            gridStamps.CollapseAll();
            gridProfitAndLoss.CollapseAll();
            gridCash.CollapseAll();
        }
        ...
        protected void ASPxGridView1_SummaryDisplayTextBranch(object sender, ASPxGridViewSummaryDisplayTextEventArgs e)
        {
            ...
            if (e.Item.FieldName == "Narration")
                e.Text = string.Format("Bal.{0}", Convert.ToDouble(e.Value));
        ...
        protected void ASPxGridView1_OnCustomSummaryCalculateBranch(object sender, CustomSummaryEventArgs e)
        {
            if (e.IsTotalSummary)
            {
                ...
                {
                    decimal Credit1 = Convert.ToDecimal(grid.TotalSummary["Credit"]);
                    decimal Debit1 = Convert.ToDecimal(grid.TotalSummary["Debit"]);
                    if (Credit1 <= Debit1)
                    {
        ...
        protected void ASPxGridView1_OnCustomSummaryCalculateInvestment(object sender, CustomSummaryEventArgs e)
        {
            if (e.IsTotalSummary)
            {
                ...
                if (x.FieldName.ToString() == "Narration")
                {
                    decimal Credit1 = Convert.ToDecimal(gridInvestments.TotalSummary["Credit"]);
                    decimal Debit1 = Convert.ToDecimal(gridInvestments.TotalSummary["Debit"]);
                    if (Credit1 <= Debit1)
                    {
                        e.TotalValue = Debit1 - Credit1;
                    }
            ...
            if (e.IsGroupSummary)
            {
                ...
                if (x.FieldName.ToString() == "Narration")
                {
                    decimal Credit1 = Convert.ToDecimal(e.GetGroupSummary(e.GroupRowHandle, gridInvestments.GroupSummary["Credit"]));
                    decimal Debit1 = Convert.ToDecimal(e.GetGroupSummary(e.GroupRowHandle, gridInvestments.GroupSummary["Debit"]));
                    if (Credit1 <= Debit1)
                    {
                        e.TotalValue = Debit1 - Credit1;
                    }
        ...
        protected void ASPxGridView1_OnCustomSummaryCalculateOtherItems(object sender, CustomSummaryEventArgs e)
        {
            if (e.IsTotalSummary)
            {
                ...
                if (x.FieldName.ToString() == "Narration")
                {
                    decimal Credit1 = Convert.ToDecimal(gridOtherItems.TotalSummary["Credit"]);
                    decimal Debit1 = Convert.ToDecimal(gridOtherItems.TotalSummary["Debit"]);
                    if (Credit1 <= Debit1)
                    {
                        e.TotalValue = Debit1 - Credit1;
                    }
            ...
            if (e.IsGroupSummary)
            {
                ...
                if (x.FieldName.ToString() == "Narration")
                {
                    decimal Credit1 = Convert.ToDecimal(e.GetGroupSummary(e.GroupRowHandle, gridOtherItems.GroupSummary["Credit"]));
                    decimal Debit1 = Convert.ToDecimal(e.GetGroupSummary(e.GroupRowHandle, gridOtherItems.GroupSummary["Debit"]));
                    if (Credit1 <= Debit1)
                    {
                        e.TotalValue = Debit1 - Credit1;
                    }
        ...
        protected void ASPxGridView1_OnCustomSummaryCalculateBanks(object sender, CustomSummaryEventArgs e)
        {
            if (e.IsTotalSummary)
            {
                ...
                if (x.FieldName.ToString() == "Narration")
                {
                    decimal Credit1 = Convert.ToDecimal(gridBanks.TotalSummary["Credit"]);
                    decimal Debit1 = Convert.ToDecimal(gridBanks.TotalSummary["Debit"]);
                    if (Credit1 <= Debit1)
                    {
                        e.TotalValue = Debit1 - Credit1;
                    }
            ...
            if (e.IsGroupSummary)
            {
                ...
                if (x.FieldName.ToString() == "Narration")
                {
                    decimal Credit1 = Convert.ToDecimal(e.GetGroupSummary(e.GroupRowHandle, gridBanks.GroupSummary["Credit"]));
                    decimal Debit1 = Convert.ToDecimal(e.GetGroupSummary(e.GroupRowHandle, gridBanks.GroupSummary["Debit"]));
                    if (Credit1 <= Debit1)
                    {
                        e.TotalValue = Debit1 - Credit1;
                    }
        ...
        protected void ASPxGridView1_OnCustomSummaryCalculateChits(object sender, CustomSummaryEventArgs e)
        {
            if (e.IsTotalSummary)
            {
                ...
                if (x.FieldName.ToString() == "Narration")
                {
                    decimal Credit1 = Convert.ToDecimal(gridChits.TotalSummary["Credit"]);
                    decimal Debit1 = Convert.ToDecimal(gridChits.TotalSummary["Debit"]);
                    if (Credit1 <= Debit1)
                    {
                        e.TotalValue = Debit1 - Credit1;
                    }
            ...
            if (e.IsGroupSummary)
            {
                ...
                if (x.FieldName.ToString() == "Narration")
                {
                    decimal Credit1 = Convert.ToDecimal(e.GetGroupSummary(e.GroupRowHandle, gridChits.GroupSummary["Credit"]));
                    decimal Debit1 = Convert.ToDecimal(e.GetGroupSummary(e.GroupRowHandle, gridChits.GroupSummary["Debit"]));
                    if (Credit1 <= Debit1)
                    {
                        e.TotalValue = Debit1 - Credit1;
                    }
        ...
        protected void ASPxGridView1_OnCustomSummaryCalculateForemanChits(object sender, CustomSummaryEventArgs e)
        {
            if (e.IsTotalSummary)
            {
                ...
                if (x.FieldName.ToString() == "Narration")
                {
                    decimal Credit1 = Convert.ToDecimal(gridForemanChits.TotalSummary["Credit"]);
                    decimal Debit1 = Convert.ToDecimal(gridForemanChits.TotalSummary["Debit"]);
                    if (Credit1 <= Debit1)
                    {
                        e.TotalValue = Debit1 - Credit1;
                    }
            ...
            if (e.IsGroupSummary)
            {
                ...
                if (x.FieldName.ToString() == "Narration")
                {
                    decimal Credit1 = Convert.ToDecimal(e.GetGroupSummary(e.GroupRowHandle, gridForemanChits.GroupSummary["Credit"]));
                    decimal Debit1 = Convert.ToDecimal(e.GetGroupSummary(e.GroupRowHandle, gridForemanChits.GroupSummary["Debit"]));
                    if (Credit1 <= Debit1)
                    {
                        e.TotalValue = Debit1 - Credit1;
                    }
        ...
        protected void ASPxGridView1_OnCustomSummaryCalculateDecreeDebtors(object sender, CustomSummaryEventArgs e)
        {
            if (e.IsTotalSummary)
            {
                ...
                if (x.FieldName.ToString() == "Narration")
                {
                    decimal Credit1 = Convert.ToDecimal(gridDecreeDebtors.TotalSummary["Credit"]);
                    decimal Debit1 = Convert.ToDecimal(gridDecreeDebtors.TotalSummary["Debit"]);
                    if (Credit1 <= Debit1)
                    {
                        e.TotalValue = Debit1 - Credit1;
                    }
            ...
            if (e.IsGroupSummary)
            {
                ...
                if (x.FieldName.ToString() == "Narration")
                {
                    decimal Credit1 = Convert.ToDecimal(e.GetGroupSummary(e.GroupRowHandle, gridDecreeDebtors.GroupSummary["Credit"]));
                    decimal Debit1 = Convert.ToDecimal(e.GetGroupSummary(e.GroupRowHandle, gridDecreeDebtors.GroupSummary["Debit"]));
                    if (Credit1 <= Debit1)
                    {
                        e.TotalValue = Debit1 - Credit1;
                    }
        ...
        protected void ASPxGridView1_OnCustomSummaryCalculateLoans(object sender, CustomSummaryEventArgs e)
        {
            if (e.IsTotalSummary)
            {
                ...
                if (x.FieldName.ToString() == "Narration")
                {
                    decimal Credit1 = Convert.ToDecimal(gridLoans.TotalSummary["Credit"]);
                    decimal Debit1 = Convert.ToDecimal(gridLoans.TotalSummary["Debit"]);
                    if (Credit1 <= Debit1)
                    {
                        e.TotalValue = Debit1 - Credit1;
                    }
            ...
            if (e.IsGroupSummary)
            {
                ...
                if (x.FieldName.ToString() == "Narration")
                {
                    decimal Credit1 = Convert.ToDecimal(e.GetGroupSummary(e.GroupRowHandle, gridLoans.GroupSummary["Credit"]));
                    decimal Debit1 = Convert.ToDecimal(e.GetGroupSummary(e.GroupRowHandle, gridLoans.GroupSummary["Debit"]));
                    if (Credit1 <= Debit1)
                    {
                        e.TotalValue = Debit1 - Credit1;
                    }
        ...
        protected void ASPxGridView1_OnCustomSummaryCalculateAdvances(object sender, CustomSummaryEventArgs e)
        {
            if (e.IsTotalSummary)
            {
                ...
                if (x.FieldName.ToString() == "Narration")
                {
                    decimal Credit1 = Convert.ToDecimal(gridSundriesAndAdvances.TotalSummary["Credit"]);
                    decimal Debit1 = Convert.ToDecimal(gridSundriesAndAdvances.TotalSummary["Debit"]);
                    if (Credit1 <= Debit1)
                    {
                        e.TotalValue = Debit1 - Credit1;
                    }
            ...
            if (e.IsGroupSummary)
            {
                ...
                if (x.FieldName.ToString() == "Narration")
                {
                    decimal Credit1 = Convert.ToDecimal(e.GetGroupSummary(e.GroupRowHandle, gridSundriesAndAdvances.GroupSummary["Credit"]));
                    decimal Debit1 = Convert.ToDecimal(e.GetGroupSummary(e.GroupRowHandle, gridSundriesAndAdvances.GroupSummary["Debit"]));
                    if (Credit1 <= Debit1)
                    {
                        e.TotalValue = Debit1 - Credit1;
                    }
        ...
        protected void ASPxGridView1_OnCustomSummaryCalculateStamps(object sender, CustomSummaryEventArgs e)
        {
            if (e.IsTotalSummary)
            {
                ...
                if (x.FieldName.ToString() == "Narration")
                {
                    decimal Credit1 = Convert.ToDecimal(gridStamps.TotalSummary["Credit"]);
                    decimal Debit1 = Convert.ToDecimal(gridStamps.TotalSummary["Debit"]);
                    if (Credit1 <= Debit1)
                    {
                        e.TotalValue = Debit1 - Credit1;
                    }
            ...
            if (e.IsGroupSummary)
            {
                ...
                if (x.FieldName.ToString() == "Narration")
                {
                    decimal Credit1 = Convert.ToDecimal(e.GetGroupSummary(e.GroupRowHandle, gridStamps.GroupSummary["Credit"]));
                    decimal Debit1 = Convert.ToDecimal(e.GetGroupSummary(e.GroupRowHandle, gridStamps.GroupSummary["Debit"]));
                    if (Credit1 <= Debit1)
                    {
                        e.TotalValue = Debit1 - Credit1;
                    }
        ...
        protected void ASPxGridView1_OnCustomSummaryCalculateProfitandLoss(object sender, CustomSummaryEventArgs e)
        {
            if (e.IsTotalSummary)
            {
                ...
                if (x.FieldName.ToString() == "Narration")
                {
                    decimal Credit1 = Convert.ToDecimal(gridProfitAndLoss.TotalSummary["Credit"]);
                    decimal Debit1 = Convert.ToDecimal(gridProfitAndLoss.TotalSummary["Debit"]);
                    if (Credit1 <= Debit1)
                    {
                        e.TotalValue = Debit1 - Credit1;
                    }
            ...
            if (e.IsGroupSummary)
            {
                ...
                if (x.FieldName.ToString() == "Narration")
                {
                    decimal Credit1 = Convert.ToDecimal(e.GetGroupSummary(e.GroupRowHandle, gridProfitAndLoss.GroupSummary["Credit"]));
                    decimal Debit1 = Convert.ToDecimal(e.GetGroupSummary(e.GroupRowHandle, gridProfitAndLoss.GroupSummary["Debit"]));
                    if (Credit1 <= Debit1)
                    {
                        e.TotalValue = Debit1 - Credit1;
                    }
        ...
        protected void ASPxGridView1_OnCustomSummaryCalculateCash(object sender, CustomSummaryEventArgs e)
        {
            if (e.IsTotalSummary)
            {
                ...
                if (x.FieldName.ToString() == "Narration")
                {
                    decimal Credit1 = Convert.ToDecimal(gridCash.TotalSummary["Credit"]);
                    decimal Debit1 = Convert.ToDecimal(gridCash.TotalSummary["Debit"]);
                    if (Credit1 <= Debit1)
                    {
                        e.TotalValue = Debit1 - Credit1;
                    }
            ...
            if (e.IsGroupSummary)
            {
                ...
                if (x.FieldName.ToString() == "Narration")
                {
                    decimal Credit1 = Convert.ToDecimal(e.GetGroupSummary(e.GroupRowHandle, gridCash.GroupSummary["Credit"]));
                    decimal Debit1 = Convert.ToDecimal(e.GetGroupSummary(e.GroupRowHandle, gridCash.GroupSummary["Debit"]));
                    if (Credit1 <= Debit1)
                    {
                        e.TotalValue = Debit1 - Credit1;
                    }
