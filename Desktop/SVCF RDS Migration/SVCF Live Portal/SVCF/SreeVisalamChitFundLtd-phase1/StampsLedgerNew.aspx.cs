...
{
    public partial class StampsLedgerNew : System.Web.UI.Page
    {
        #region Object
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                select();
                grid.SettingsText.Title = "Trial Balance of Stamps from " + txtFromDate.Text + " to " + txtToDate.Text;
                ApplyLayout(1);
