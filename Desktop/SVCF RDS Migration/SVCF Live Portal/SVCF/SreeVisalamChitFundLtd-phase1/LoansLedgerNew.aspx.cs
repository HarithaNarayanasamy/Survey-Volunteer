...
{
    public partial class LoansLedgerNew : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                select();
                grid.SettingsText.Title = "Trial Balance of Loans from " + txtFromDate.Text + " to " + txtToDate.Text;
                ApplyLayout(1);
