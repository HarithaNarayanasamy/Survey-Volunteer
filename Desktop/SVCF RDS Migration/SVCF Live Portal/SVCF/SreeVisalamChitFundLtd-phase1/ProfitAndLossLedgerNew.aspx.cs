...
{
    public partial class ProfitAndLossLedgerNew : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                grid.SettingsText.Title = "Trial Balance of Profit and Loss from " + txtFromDate.Text + " to " + txtToDate.Text;
                select();
                ApplyLayout(1);
