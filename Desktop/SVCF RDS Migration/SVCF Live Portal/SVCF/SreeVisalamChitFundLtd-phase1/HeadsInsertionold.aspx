            ...
            <div class="box_c">
                ...
                <div class="box_c_content">
                    <div class="row">
                                                ...
                                                <table cellpadding="10px" cellspacing="10px" style="margin: 0 auto;">
                                                    <tr>
                                                        ...
                                                        <td style="padding-left: 10px;">
                                                            <asp:DropDownList Width="240px" TabIndex="1" CssClass="chzn-select" ValidationGroup="Child"
                                                                ID="ddlMaster" OnSelectedIndexChanged="ddlMaster_SelectedIndexChanged" AutoPostBack ="true" runat="server">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Button OnClick="btnChildInsert_OnClick" TabIndex="3" Text="Insert" Style="margin: 0 auto;"
                                                                ValidationGroup="Child" ID="btnChildInsert" runat="server" CssClass="GreenyPushButton">
                                                            </asp:Button>
                                                            <asp:Button OnClientClick="clearValidationErrors();" TabIndex="4" Text="Cancel" OnClick="btnNo_Click"
                                                                CausesValidation="false" CssClass="GreenyPushButton" ID="Button2" runat="server">
                                                            </asp:Button>
                                                        </td>
                                                    </tr>
                                                </table>
                        ...
                        <asp:Panel CssClass="raised" ID="pnlpopup" runat="server" Width="600px" Style="min-height: 100px;
                            text-align: center;">
