...
{
    public partial class BanksLedgerNew : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                grid.SettingsText.Title = "Trial Balance of Banks from " + txtFromDate.Text + " to " + txtToDate.Text;
                select();
                ApplyLayout(1);
