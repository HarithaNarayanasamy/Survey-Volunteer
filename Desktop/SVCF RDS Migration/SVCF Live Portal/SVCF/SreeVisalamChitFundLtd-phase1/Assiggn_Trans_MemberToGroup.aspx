<%@ Page Language="C#" Culture="en-GB" MasterPageFile="~/Branch.Master" AutoEventWireup="true" CodeBehind="Assiggn_Trans_MemberToGroup.aspx.cs"
    Inherits="SreeVisalamChitFundLtd_phase1.Assiggn_Trans_MemberToGroup_" Title="SVCF Admin Panel" %>
                        ...
                        <table class="tabbed" cellpadding="3" cellspacing="3" style="margin: 0 auto;">
                            ...
                            <tr>
                                <td style="vertical-align: top !important; padding-top: 5px;">
                                    <asp:Label ID="Label5" runat="server" Text="Assign Date"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox runat="server" TabIndex="5" ID="txtSuggestedDate" Width="200px" CssClass="input-text maskdate"></asp:TextBox>
                                    <asp:RequiredFieldValidator EnableClientScript="false"  ID="RequiredFieldValidator1" ErrorMessage="Enter Date"
                                        ControlToValidate="txtSuggestedDate" ValidationGroup="add" Display="Dynamic"
                                        runat="server"></asp:RequiredFieldValidator>
                                    <asp:CompareValidator EnableClientScript="false" ForeColor="Red" Type="Date" ID="CompareValidator5" ValidationGroup="add"
                                        ControlToValidate="txtSuggestedDate" Display="Dynamic" Operator="DataTypeCheck"
                                        runat="server" ErrorMessage="Incorrect!!!"></asp:CompareValidator>
                                </td>
                                <td style="vertical-align: top !important; padding-top: 5px;">
                                    <asp:Label ID="Label6" runat="server" Text="Foreman recognised Date"></asp:Label>
                                </td>
                                <td style="vertical-align: top !important;">
                                    <asp:TextBox runat="server" TabIndex="6" ID="txtForemanDate" Width="200px" CssClass="input-text maskdate"></asp:TextBox>
                                    <asp:RequiredFieldValidator EnableClientScript="false" ID="RequiredFieldValidator2" ErrorMessage="Enter Date"
                                        ControlToValidate="txtForemanDate" ValidationGroup="add" Display="Dynamic" runat="server"></asp:RequiredFieldValidator>
                                    <asp:CompareValidator EnableClientScript="false" ForeColor="Red" Type="Date" ID="CompareValidator6" ValidationGroup="add"
                                        ControlToValidate="txtForemanDate" Display="Dynamic" Operator="DataTypeCheck"
                                        runat="server" ErrorMessage="Incorrect!!!"></asp:CompareValidator>
                                </td>
                            </tr>
                        </table>
