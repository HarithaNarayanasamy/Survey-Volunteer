...
namespace SreeVisalamChitFundLtd_phase1
{
    public partial class PaymentRegister : System.Web.UI.Page
    {
        ...
        protected void Export_click1(object sender, MenuItemEventArgs e)
        {
        ...
        //New Code added - 18-01-2019
        protected void Export_click(object source, DevExpress.Web.ASPxMenu.MenuItemEventArgs e)
        {
            if (ddlChit.SelectedValue == "--select--")
            {
                AccessDataSource1.ConnectionString = CommonClassFile.ConnectionString;
            ...
            gridexcel.FileName = "PaymentRegister" + DateTime.Now.ToString();
            grid.SettingsPager.Mode = GridViewPagerMode.ShowAllRecords;
