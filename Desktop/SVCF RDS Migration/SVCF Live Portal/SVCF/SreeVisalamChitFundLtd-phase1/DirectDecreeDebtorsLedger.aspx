<%@ Page Culture="en-GB" Language="C#" MasterPageFile="~/Branch.Master" AutoEventWireup="true"
    CodeBehind="DirectDecreeDebtorsLedger.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.DirectDecreeDebtorsLedger"
                ...
                <div class="box_c_content">
                    <div class="row">
                        ...
                        <asp:DropDownList ID="drpdownBranchlist" CssClass="chzn-select" runat="server" AutoPostBack="true"></asp:DropDownList>
                            ...
                            <div style="display:table-cell; vertical-align:top; padding-top:4px; padding-right:5px !important;">
                                <asp:DropDownList ID="ddldegreenode" Width="150px" CssClass="chzn-select" AutoPostBack="true" OnSelectedIndexChanged="ddldegreenode_OnSelectedIndexChanged"
                                  runat="server"></asp:DropDownList>   

                            </div>
                            <div style="display: table-cell; vertical-align: top; padding-top: 10px; padding-right: 5px !important;">
                                <asp:Label ID="Label4" runat="server" Text="Head: "></asp:Label>
                            </div>
                            <div style="display:table-cell; vertical-align:top; padding-top:4px; padding-right:5px !important;">
                                <asp:DropDownList ID="ddldegree" Width="150px" CssClass="chzn-select" AutoPostBack="true" OnSelectedIndexChanged="ddldegree_OnSelectedIndexChanged"
                                  runat="server"></asp:DropDownList>   

                            </div>
                            <div style="display: table-cell; vertical-align: top; float: right; padding-right: 5px; text-align: right; margin-top: -10px;">
                        ...
                        <dx:ASPxPageControl Width="100%" ID="carTabPage" TabAlign="Left" TabPosition="Top"
                            ...
                            <TabPages>
                                    ...
                                    <ContentCollection>
                                        <dx:ContentControl ID="ContentControl2" runat="server">
                                            <dx:ASPxGridView Styles-AlternatingRow-BackColor="LightGray" Style="margin: 0 auto; width: 100%;"
                                                ID="gridprev" ClientInstanceName="gridprev" runat="server" Settings-ShowColumnHeaders="false"
                                                ...
                                                <SettingsText Title="Decree Debtors Ledger" />
                                ...
                                <Title Font-Size="07" VerticalAlign="Middle" HorizontalAlign="Center" Paddings-PaddingBottom="2px" Paddings-PaddingTop="2px">
                                            ...
                                            <dx:ASPxGridView Styles-AlternatingRow-BackColor="LightGray" Style="margin: 0 auto; width: 115%;"
                                                ...
                                                <Columns>
                                                    <dx:GridViewDataColumn FieldName="Date">
                                                     ...
                                                     <dx:GridViewDataColumn FieldName="Node">
                                                    </dx:GridViewDataColumn>
                                                    <dx:GridViewDataColumn FieldName="Head">
                                                    </dx:GridViewDataColumn>
                                                    <dx:GridViewDataColumn FieldName="Narration">
