<%@ Page Culture="en-GB" Language="C#" MasterPageFile="~/Branch.Master" AutoEventWireup="true"
    CodeBehind="DirectForemanChitsLedger.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.DirectForemanChitsLedger"
    ...
    <div class="row">
        ...
        <div style="display: table-cell; vertical-align: top;padding-top:4px; padding-right: 5px !important;">
            <asp:DropDownList ID="ddlGroup" Width="150px" CssClass="chzn-select" AutoPostBack="true" OnSelectedIndexChanged="ddlGroup_OnSelectedIndexChanged"
                ...
                <asp:ListItem Text="Token and Date" Value="Token and Date"></asp:ListItem>
                <asp:ListItem Text="Token alone" Value="Token alone"></asp:ListItem>
            </asp:DropDownList>
        </div>
                         ...
                         <div style="display: table-cell; vertical-align: top; padding-top: 10px; padding-right: 5px !important;">
                            ...
                            <div style="display:table-cell; vertical-align:top; padding-top:4px; padding-right:5px !important;">
                                <asp:DropDownList ID="ddlFormannode" Width="150px" CssClass="chzn-select" AutoPostBack="true" OnSelectedIndexChanged="ddlFormannode_OnSelectedIndexChanged"
         ...
         <div style="display: table-cell; vertical-align: top; padding-top: 10px; padding-right: 5px !important;">
                            ...
                            <div style="display:table-cell; vertical-align:top; padding-top:4px; padding-right:5px !important;">
                                <asp:DropDownList ID="ddlForman" Width="150px" CssClass="chzn-select" AutoPostBack="true" OnSelectedIndexChanged="ddlForman_OnSelectedIndexChanged"
                                  runat="server"></asp:DropDownList>   
        ...
        <div style="display: table-cell; vertical-align: top; float: right; padding-right: 5px;
                ...
                <dx:ASPxMenu OnItemClick="Export_click" ID="mMain" runat="server" AllowSelectItem="True"
                    ...
                    <Items>
                        <dx:MenuItem Text="Export">
                          ...
                          <div style="display:table-cell; float:right; padding-left:5px; text-align:right; margin-top:-8px; ">
                        ...
                        <dx:ASPxPageControl Width="100%" ID="carTabPage" TabAlign="Left" TabPosition="Top"
                            ...
                            <TabPages>
                                ...
                                <Title Font-Size="07" VerticalAlign="Middle" HorizontalAlign="Center" Paddings-PaddingBottom="2px" Paddings-PaddingTop="2px">
                                            ...
                                            <dx:ASPxGridView Styles-AlternatingRow-BackColor="LightGray" Style="margin: 0 auto;
                                                width: 110%;" OnSummaryDisplayText="ASPxGridView1_SummaryDisplayText" OnCustomSummaryCalculate="ASPxGridView1_OnCustomSummaryCalculate"
            ...
            <dx:ASPxSummaryItem FieldName="Narration" SummaryType="Custom" />
                                                ...
                                                <Columns>
                                                    ...
                                                    <dx:GridViewDataColumn FieldName="Narration" CellStyle-Wrap="True"    > 
                                                    </dx:GridViewDataColumn>
                                                    <dx:GridViewDataColumn FieldName="Credit">
                                                    </dx:GridViewDataColumn>
                                                    <dx:GridViewDataColumn FieldName="Debit">
