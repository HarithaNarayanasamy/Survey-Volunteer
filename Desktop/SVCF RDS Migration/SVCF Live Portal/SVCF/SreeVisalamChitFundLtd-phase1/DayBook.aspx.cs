        ...
        protected void select()
         {
            ...
            try
            {
                ...
                dt = balayer.GetDataTable("select * from ( select  ChoosenDate,v1.Series,v1.Voucher_Type,v1.Narration,v1.AppReceiptno,(case when v1.Voucher_Type='C' and " +
                     "v1.Other_Trans_Type<>5 then v1.Amount else 0.00 end )as `Amount`,null as amt," +
                     "(case when v1.Voucher_Type='D' and v1.Other_Trans_Type<>5 and v1.Series='VOUCHER' then v1.Amount else 0.00 end )as `DebitAmount`," +
                     "g1.GrpMemberID,v1.Voucher_No,a1.TotalCommission,g1.MemberName,a1.KasarAmount,g1.Head_Id,g1.GroupID,a1.CurrentDueAmount " +
                            ...
                            if (dt.Rows[i]["Head_Id"].ToString() != "")
                            {
                                if (dt.Rows[i].ItemArray[1].ToString() == "PAYMENT" || dt.Rows[i].ItemArray[1].ToString() == "FCP")
                                {
                                  ...
                                  //  {
                                        ...
                                        {
                                            pr = new DataTable();
                                        pr = balayer.GetDataTable("select t1.PrizedAmount as PrizedAmount,v1.Narration,t1.Description,v1.Voucher_No,v1.AppReceiptno, a1.TotalCommission,a1.KasarAmount,a1.PrizedMemberID,t1.PaymentDate,a1.CurrentDueAmount " +
                                ...
                                if (dt.Rows[i]["ChoosenDate"].ToString() != "")
                                {
                                    ...
                                    if (pr.Rows.Count > 0)
                                    {
                                       ...
                                       // {
                                        ...
                                        dr["Total"] = total;
                                        //18/05/2021 Bala
                                        //if (pr.Rows[0]["Series"].ToString() == "BCAPP" || pr.Rows[0]["Series"].ToString() == "CPAPP" || pr.Rows[0]["Series"].ToString() == "CPWEB")
                                        if(!string.IsNullOrEmpty(pr.Rows[0]["AppReceiptno"].ToString()))
                                        {
                                            dr["Voucher_No"] = pr.Rows[0]["AppReceiptno"];
                                        }
                                        else
                                        {
                                    ...
                                    else
                                    {
                                        dr["Amount"] = "0";
                                           ...
                                           if(Convert.ToString(dt.Rows[i]["amt"])=="")
                                            ...
                                            //}
                                            //18/05/2021 Bala
                                            //if (dt.Rows[i]["Series"].ToString() == "BCAPP" || dt.Rows[i]["Series"].ToString() == "CPAPP" || dt.Rows[i]["Series"].ToString() == "CPWEB")
                                            if(!string.IsNullOrEmpty(dt.Rows[i]["AppReceiptno"].ToString()))
                                            {
                                                dr["Voucher_No"] = dt.Rows[i]["AppReceiptno"];
                                            }
                                            else
                                            {
                ...
                //18/05/2021- add BCAPP in series

                dt1 = balayer.GetDataTable("select * from ( select  ChoosenDate,v1.Series,v1.Voucher_Type,v1.Narration,v1.AppReceiptno,(case when v1.Voucher_Type='C' and " +
                   "v1.Other_Trans_Type<>5 then v1.Amount else 0.00 end )as `Amount`,null as amt," +
                   "(case when v1.Voucher_Type='D' and v1.Other_Trans_Type<>5 and v1.Series='VOUCHER' then v1.Amount else 0.00 end )as `DebitAmount`," +
                   "g1.GrpMemberID,v1.Voucher_No,a1.TotalCommission,g1.MemberName,a1.KasarAmount,g1.Head_Id,g1.GroupID,a1.CurrentDueAmount " +
                                ...
                                if (dt1.Rows[i]["ChoosenDate"].ToString() != "")
                                {
                                    ...
                                    if (pr.Rows.Count > 0)
                                    {
                                      ...
                                      //  {
                                        ...
                                        if(!string.IsNullOrEmpty(pr.Rows[0]["AppReceiptno"].ToString()))
                                        {
                                            dr1["Voucher_No"] = pr.Rows[0]["AppReceiptno"];
                                        }
                                        else
                                        {
                                    ...
                                    else
                                    {
                                        ...
                                        if (dt1.Rows[i]["Amount"].ToString() != "")
                                        {
                                            ...
                                            //    }
                                            //}
                                            if (dt1.Rows[0]["Series"].ToString() == "BCAPP" || dt1.Rows[0]["Series"].ToString() == "CPAPP" || dt1.Rows[0]["Series"].ToString() == "CPWEB")
                                            {
                                                dr1["Voucher_No"] = dt1.Rows[i]["AppReceiptno"];
                                            }
                                            else
                                            {
