<%@ Page Language="C#" Culture="en-GB" MasterPageFile="~/Branch.Master" AutoEventWireup="true"
    CodeBehind="DDecree.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.DDecree" %>
                                ...
                                <div style="display: inline; zoom: 1; text-align: center;">
                                    <div style="margin-left: auto; margin-right: auto; display: table;">
                                        <table cellspacing="4px" width="100%">
                                            <tr>
                                                ...
                                                <td style="vertical-align: top; padding-left: 6px; text-align: left;">
                                                    <asp:TextBox AutoPostBack="true" Width="100" TabIndex="1" ID="txtDate" CssClass="input-text maskdate"
                                                ...
                                                <td style="vertical-align: top; padding-left: 6px; text-align: left;">
                                                    <asp:TextBox Width="100" TabIndex="2" ValidationGroup="Generate" ID="txtSeries" CssClass="input-text"
                                                        runat="server"></asp:TextBox>
                                        ...
                                        <asp:GridView ID="GridGuardians" runat="server" AutoGenerateColumns="False" BorderStyle="None"
                                            ...
                                            OnRowDataBound="GridGuardians_RowDataBound" ShowHeader="false" ShowFooter="true" OnSelectedIndexChanged="GridGuardians_SelectedIndexChanged">
                                            <Columns>
                                                        ...
                                                        <table style="border: none;">
                                                            <tr>
                                                                <td style="height: 40px;">
                                                                    ...
                                                                    <asp:Label ID="Label5" runat="server" Text="Heads"></asp:Label>
                                                                    <asp:DropDownList CssClass="chzn-select" Style="width: 250px !important;" OnSelectedIndexChanged="ddlBothGridHead1_SelectedIndexChanged"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:ImageButton OnClick="btnAdd_GridGuardiansDebit_RowCommand_click" TabIndex="-1"
                                                                        ID="imgBtnAddDebit" runat="server" CausesValidation="True" Height="24" ValidationGroup="GrpRowDebit"
                                                                        ImageUrl="~/Styles/Image/Images/round_plus_16.png" ToolTip="Add New Transaction"
                                                                        Width="24" />
                                                                </td>
                                                                <td>
                                                    ...
                                                    <ItemTemplate>
                                                        <table style="border: none;">
                                                            <tr>
                                                                <td style="height: 40px;" align="center">
                                                                    CC No.
                                                                    <asp:TextBox Width="100" TabIndex="60" Text='<%#Eval("CC") %>' ValidationGroup="GrpRowDebit"
                                                                        CssClass="twitterStyleTextbox sp_number" ID="txtCC" runat="server">
                                                                    </asp:TextBox>
                                                                    <asp:RequiredFieldValidator Display="Dynamic" ValidationGroup="GrpRowDebit" ControlToValidate="txtCC"
                                                                        ID="rfvCC" ErrorMessage="*" runat="server"> </asp:RequiredFieldValidator>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="ARC">
                                                    <ItemTemplate>
                                                        <table style="border: none;">
                                                            <tr>
                                                                <td style="height: 40px;" align="center">
                                                                    Number
                                                                    <asp:TextBox Width="100" TabIndex="61" Text='<%#Eval("ARC") %>' ValidationGroup="GrpRowDebit"
                                                                        CssClass="twitterStyleTextbox" ID="txtARC" runat="server">
                                                                    </asp:TextBox>
                                                                    <asp:RequiredFieldValidator Display="Dynamic" ValidationGroup="GrpRowDebit" ControlToValidate="txtARC"
                                                                        ID="rfvARC" ErrorMessage="*" runat="server"> </asp:RequiredFieldValidator>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </ItemTemplate>
                                                    ...
                                                    <ItemTemplate>
                                                        <table style="border: none;">
                                                            <tr>
                                                                <td style="height: 40px;">
                                                                    <asp:Label ID="lblDesc" runat="server" Text="Description"></asp:Label>
                                                                    <asp:TextBox TextMode="MultiLine" Height="50" TabIndex="62" Text='<%#Eval("Description") %>'
