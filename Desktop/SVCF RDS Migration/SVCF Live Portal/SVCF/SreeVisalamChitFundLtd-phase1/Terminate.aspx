<%@Page Culture="en-GB" Title="" Language="C#" MasterPageFile="~/Branch.Master" AutoEventWireup="true" 
    CodeBehind="Terminate.aspx.cs" EnableEventValidation="false" Inherits="SreeVisalamChitFundLtd_phase1.Terminate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
    <style type="text/css">
        ...
        /*#ctl00_cphMainContent_gridTA.chzn-drop .chzn-search input[type="text"]
        {
            height: 16px;
        }*/
        /*.linecolor tr td
            ...
            <td style="background-color:#FDF5E6; border: 1px solid black" align="center">
                <asp:Label ID="lblCaption" runat="server" Style="font-weight: bold;
                 ...
                 <asp:GridView ID="gridTA" runat="server" BorderStyle="None" CssClass="Grid" HeaderStyle-Font-Bold="true" Font-Names="Verdana" ForeColor="Black" GridLines="Both" CellSpacing="2"                                         
                        AutoGenerateColumns="False" PageSize="50" OnRowDataBound="gridTA_RowDataBound" ShowFooter="True" BackColor="White" BorderColor="Red" BorderWidth="1px" CellPadding="2" Width="788px" Font-Size="10.2pt">

                                        <Columns>                       

                           <asp:TemplateField HeaderText="Chit Number" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="3px">
                                 <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Member Name" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="10px">
                             ...
                             <asp:TemplateField HeaderText="Credit" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="4px">
                                 <ItemTemplate>
                                     <asp:Label ID="lblcredit" runat="server" Text='<%#Eval("TCredit")%>' ItemStyle-HorizontalAlign="Right"></asp:Label>
                                 </ItemTemplate>
                                  <FooterTemplate>
                        ...
                        <%-- <asp:TemplateField HeaderText="Debit" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="4px" Visible="false">
                                 <ItemTemplate>
                                     <asp:Label ID="lbldebit" runat="server" Visible="false" Text='<%#Eval("Debit")%>'></asp:Label></ItemTemplate>
                                <FooterTemplate>
                                    <asp:Label ID="totaldebit" runat="server" Visible="false"> </asp:Label>
                               </FooterTemplate>
                            </asp:TemplateField>--%>

                             <asp:TemplateField HeaderText="Excess" ItemStyle-HorizontalAlign="Right"  ItemStyle-Width="5px">
                                 <ItemTemplate>
                        ...
                        <%-- <asp:TemplateField HeaderText="N-P.Arrear" ItemStyle-Width="4px" Visible="false">
                                <ItemTemplate>
                                    <asp:Label ID="lblnparrear" runat="server" Visible="false" Text='<%#Eval("NPArrier")%>'></asp:Label>
                                </ItemTemplate>
                                 <FooterTemplate>
                                    <asp:Label ID="totalnparrier" runat="server" Visible="false"></asp:Label>
                                </FooterTemplate>
                            </asp:TemplateField>--%>

                            <asp:TemplateField HeaderText="Arrear" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="4px">
                                <ItemTemplate>
                             ...
                             <asp:TemplateField HeaderText="Branches" ItemStyle-Width="5px">
                                <ItemTemplate>
                 ...
                 <asp:Panel ID="PanelSummary"  BorderStyle="Solid" runat="server" CssClass="panelstyle">
                        ...
                        <table id="tble" runat="server">
                            <tr>
                               <td>
                                <asp:label ID="Label3" runat="server" Text="Non Prized Dividend " Font-Bold="true"> </asp:label>
                               </td>                             
                                <td class="paddingtd">
                            ...
                            <tr>
                               <td>
                        <asp:label ID="Label4" runat="server" Text="Excess " Font-Bold="true" > </asp:label>
                                </td>                              
                                <td class="paddingtd">
                      ...
                      <asp:label ID="lblsummary_GrandTotal" runat="server"> </asp:label>
                             ...
                             <tr>
                               <td>
                                <asp:label ID="Label10" runat="server" Text="Arrear" Font-Bold="true"> </asp:label>
                               </td>                             
                                <td class="paddingtd">
                                   <asp:label ID="lblsummary_Arrear" runat="server"> </asp:label>
                                </td>
                            </tr> 
