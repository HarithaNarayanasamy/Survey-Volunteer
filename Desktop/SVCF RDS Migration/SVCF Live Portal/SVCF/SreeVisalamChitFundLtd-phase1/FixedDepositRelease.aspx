<%@ Page Title="" Culture="en-GB" Language="C#" MasterPageFile="~/Branch.Master"
    AutoEventWireup="true" CodeBehind="FixedDepositRelease.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.FixedDepositRelease" %>
                                    ...
                                    <div style="width: 100%">
                                        <table style="display: table; margin: 0px auto;">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList  TabIndex="1" Width="240px" AutoPostBack="true"
                                                        CssClass="chzn-select" ID="ddlGroupNumber" runat="server" OnSelectedIndexChanged="ddlGroupNumber_SelectedIndexChanged" >
                                                    </asp:DropDownList>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox TabIndex="2" ToolTip="Ex. 1000.00" placeholder="Amount" CssClass="input-text sp_float"
                                                        ID="txtAmount" runat="server" ReadOnly="true" ></asp:TextBox>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Label ID="label2" runat="server" Text="FDR Number"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:TextBox MaxLength="15" autocomplete="off" TabIndex="5" placeholder="FDR Number"
                                                        ToolTip="Ex. 50" CssClass="input-text sp_number" ID="txtChequeNumber" runat="server" ReadOnly="true" ></asp:TextBox>
                                                    <asp:RequiredFieldValidator ForeColor="Red" ID="RequiredFieldValidator3" ErrorMessage="Enter FDR Number"
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Label ID="label4" runat="server" Text="Debit Head"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:DropDownList TabIndex="6" CssClass="chzn-select" ID="ddlBranchid" runat="server"></asp:DropDownList>
                                                </td>
