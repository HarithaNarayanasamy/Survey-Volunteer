<%@ Page Culture="en-GB" Language="C#" MasterPageFile="~/Branch.Master" AutoEventWireup="true"
    CodeBehind="DirectInvestmentLedger.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.DirectInvestmentLedger"
        ...
        <div style="display: table-cell; vertical-align: top; padding-top: 4px; padding-right: 5px !important;">
            <asp:DropDownList ID="ddlGroup" Width="150px" CssClass="chzn-select" AutoPostBack="true"
                ...
                <asp:ListItem Text="Head alone" Value="Head alone"></asp:ListItem>
                       ...
                       <div style="display: table-cell; vertical-align: top; padding-top: 10px; padding-right: 5px !important;">
                                <asp:Label ID="Label5" runat="server" Text="Node: "></asp:Label>
                            </div>
                            <div style="display:table-cell; vertical-align:top; padding-top:4px; padding-right:5px !important;">
                                <asp:DropDownList ID="ddlInveshead" Width="150px" CssClass="chzn-select" AutoPostBack="true" OnSelectedIndexChanged="ddlInveshead_OnSelectedIndexChanged"
                                  runat="server"></asp:DropDownList>   
                            </div>
                        <%--   <div style="display:table-cell; vertical-align:top; padding-top:4px; padding-right:5px !important;">
                                <asp:DropDownList ID="ddlInveshead" Width="150px" CssClass="chzn-select" AutoPostBack="true"
                                  runat="server"></asp:DropDownList>   --%>
                         <div style="display: table-cell; vertical-align: top; padding-top: 10px; padding-right: 5px !important;">
                                <asp:Label ID="Label4" runat="server" Text="Investment: "></asp:Label>
                            </div>
                            <div style="display:table-cell; vertical-align:top; padding-top:4px; padding-right:5px !important;">
                              <asp:DropDownList ID="ddlInves" Width="150px" CssClass="chzn-select" AutoPostBack="true" OnSelectedIndexChanged="ddlInves_OnSelectedIndexChanged"
                                  runat="server"></asp:DropDownList> 
                    ...
                    <Items>
                       ...
                       <div style="display:table-cell; float: right; padding-left:5px; text-align:right; margin-top:-10px; ">
                        ...
                        <dx:ASPxPageControl Width="100%" ID="carTabPage" TabAlign="Left" TabPosition="Top"
                            ActivateTabPageAction="Click" runat="server" ActiveTabIndex="1" EnableHierarchyRecreation="True" OnActiveTabChanged="carTabPage_ActiveTabChanged">
                            <TabPages>
                                        ...
                                        <dx:ContentControl ID="ContentControl2" runat="server">
                                            <dx:ASPxGridView Styles-AlternatingRow-BackColor="LightGray" Style="margin: 0 auto;
                                                ...
                                                <GroupSummary>
                                                    ...
                                                    <dx:ASPxSummaryItem FieldName="Head" ShowInGroupFooterColumn="Credit" SummaryType="Custom" />
                                                </GroupSummary>
                                                <SettingsText Title="Investment Ledger" />
                                                ...
                                                <Columns>
                                                    ...
                                                    <dx:GridViewDataColumn FieldName="Credit" CellStyle-HorizontalAlign="Right">
<CellStyle HorizontalAlign="Right"></CellStyle>
                                                    </dx:GridViewDataColumn>
                                                    <dx:GridViewDataColumn FieldName="Debit" CellStyle-HorizontalAlign="Right">
<CellStyle HorizontalAlign="Right"></CellStyle>
                                                    </dx:GridViewDataColumn>
                                                </Columns>
                                                <Styles Footer-HorizontalAlign="Right" Cell-HorizontalAlign="Right" Header-VerticalAlign="Middle" Cell-Paddings-PaddingLeft="4px" Cell-Paddings-PaddingRight="5px"
...
<Paddings PaddingLeft="4px" PaddingRight="5px"></Paddings>
                                                    </Cell>
                                            ...
                                            <dx:ASPxGridViewExporter ID="gridExportprev" runat="server" GridViewID="grdTemp">
                                                <%--<Styles>
                                                 ...
                                                 <Styles>
                                                       <Cell Font-Size="10" HorizontalAlign="Right"   Wrap="false"  Paddings-PaddingBottom="4px" Paddings-PaddingTop="4px" >
<Paddings PaddingTop="4px" PaddingBottom="4px"></Paddings>
                                                         </Cell>
...
<Paddings PaddingTop="2px" PaddingBottom="2px"></Paddings>
                                            ...
                                            <dx:ASPxGridView Styles-AlternatingRow-BackColor="LightGray" Style="margin: 0 auto;
                                                ...
                                                <Settings ShowTitlePanel="true" ShowHeaderFilterButton="true" ShowFooter="true" ShowGroupFooter="VisibleIfExpanded"
                                                ...
                                                <Columns>
                                                    ...
                                                    <dx:GridViewDataColumn FieldName="LedgerHead" Visible="false">
                                                    </dx:GridViewDataColumn>
                                                    <dx:GridViewDataColumn FieldName="Narration"  >
                                                    </dx:GridViewDataColumn>
...
<Header HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True"></Header>
                                               ...
                                               <dx:ASPxGridView ID="grdTemp" runat="server" Styles-AlternatingRow-BackColor="LightGray" ClientInstanceName="grdTemp" Visible="false" Style="margin: 0 auto; width: 200%;">                                                   
                                                    <SettingsPager Visible="false" Position="Bottom" />
                                                    <ClientSideEvents Init="OnInit" EndCallback="OnEndCallback" />
                                                    <%--<Columns>                                                        
                                                        <dx:GridViewDataColumn FieldName="Title" Width="100%">
                                                        </dx:GridViewDataColumn>
                                                        <dx:GridViewDataColumn FieldName="Narration"  Width="40%">
                                                        </dx:GridViewDataColumn>
                                                        <dx:GridViewDataColumn FieldName="Credit" Width="30%">
                                                           <CellStyle CssClass="wd"></CellStyle>
                                                        </dx:GridViewDataColumn>
                                                        <dx:GridViewDataColumn  FieldName=".      Debit      ." Width="30%" >
                                                          <CellStyle CssClass="wd"></CellStyle>
                                                        </dx:GridViewDataColumn>                                                       
                                                    </Columns>--%>
                                                     <Styles Footer-HorizontalAlign="Left" Cell-HorizontalAlign="Left" Header-VerticalAlign="Middle"
