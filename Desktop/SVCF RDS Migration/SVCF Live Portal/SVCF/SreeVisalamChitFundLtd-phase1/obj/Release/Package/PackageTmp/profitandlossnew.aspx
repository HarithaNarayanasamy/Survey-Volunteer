<%@ Page Title="SVCF - Admin Page" Culture="en-GB" Language="C#" MasterPageFile="~/Branch.Master"
    AutoEventWireup="true" CodeBehind="profitandlossnew.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.profitandlossnew" %>
        ...
        <div class="twelve columns">
            <div class="box_c">
                <div class="box_c_heading  box_actions">
                    <p>
                        Profit and loss Debit details</p>
                </div>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:ImageButton  OnClick="btnAdd_GridGuardians_RowCommand_click" TabIndex="-1" ID="imgBtnAdd"
                                                                        runat="server" CausesValidation="True" Height="24" Visible="false" ValidationGroup="GrpRow"
                                                        ...
                                                        <table style="border: none;">
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <asp:RequiredFieldValidator Display="Dynamic" Visible="false" ForeColor="Red" ValidationGroup="GrpRow"
                                                ...
                                                <asp:TemplateField HeaderText="ChooseHead">
                                                    ...
                                                    <FooterTemplate>
                                                        <table style="border: none;">
                                                            <tr>
                                                                <td>
                                                                    <asp:ImageButton Visible="false" OnClick="btnAdd_GridGuardiansDebit_RowCommand_click" TabIndex="-1"
                                                                        ID="imgBtnAddDebit" runat="server" CausesValidation="True" Height="24" ValidationGroup="GrpRowDebit"
                                                                        ImageUrl="~/Styles/Image/Images/round_plus_16.png" ToolTip="Add New Transaction"
                                                                        Width="24" />
                                                                </td>
                                                                <td>
                                                                    <asp:ImageButton Visible="false" OnClick="btnRemove_GridGuardiansDebit_RowCommand_click" TabIndex="-1"
