<%@ Page Culture="en-GB" Title="SVCF Admin Panel" Language="C#" MasterPageFile="~/Branch.Master" AutoEventWireup="true" CodeBehind="TopColumnDaybookConsolidatedView.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.TopColumnDaybookConsolidatedView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <asp:LinkButton CssClass="gh_button" runat="server" OnClick="btnConsolidatedView_Click" Text="Detailed View"></asp:LinkButton>
    </div>
                ...
                <div class="box_c">
                    ...
                    <div id="bill" class="box_c_content">
                        <h3 class="sepH_a_line">
                            Sree Visalam Chit Funds Consolidated View</h3>
                        <div class="row">
                                    ...
                                    <ul>
                                        <li id="li_Branch" class="top_H"><a href="#" class="top_Ha">01. Branch.<span class="st-arrow">Open
                                            ...
                                            <asp:Panel ID="pnlBranch" CssClass="st-content" runat="server">
                                                ...
                                                <dx:ASPxGridView  OnCustomCallback="gridBranch_CustomCallback"  
                                                    ...
                                                    ClientInstanceName="grid" runat="server" DataSourceID="MySqldsBranch">
                                                    <Settings GroupFormat="{1}{2}" ShowTitlePanel="true" ShowVerticalScrollBar="true" VerticalScrollBarStyle="Virtual"
                                                        VerticalScrollableHeight="300" ShowHeaderFilterButton="true" ShowFooter="true"
                                                        ShowGroupFooter="VisibleAlways" ShowGroupPanel="false" ShowGroupedColumns="true" ShowFilterBar="Visible"
                                                        ShowFilterRow="true" />
                                                    ...
                                                    <GroupSummary>
                                                        ...
                                                        <dx:ASPxSummaryItem FieldName="Narration" ShowInGroupFooterColumn="Debit" SummaryType="Custom" />
                                                    ...
                                                    <Styles GroupFooter-HorizontalAlign="Left" Footer-HorizontalAlign="Left" Cell-HorizontalAlign="Left" Header-VerticalAlign="Middle" Header-HorizontalAlign="Center"
                                                        Header-Wrap="True">
                                        ...
                                        <li id="li_InvestMents" class="top_H"><a href="#" class="top_Ha">02. Investments.<span
                                            ...
                                            <div class="st-content">
                                                ...
                                                <dx:ASPxGridView  Style="margin: 0 auto;
                                                    ...
                                                    <Settings GroupFormat="{1}{2}" ShowTitlePanel="true" VerticalScrollableHeight="300" ShowVerticalScrollBar="true"
                                        ...
                                        <li id="li_Banks" class="top_H"><a href="#" class="top_Ha">03. Banks.<span class="st-arrow">Open
                                            ...
                                            <div class="st-content">
                                                ...
                                                <dx:ASPxGridView  Style="margin: 0 auto;
                                                    ...
                                                    OnCustomCallback="grid_CustomCallback">
                                                    <Settings GroupFormat="{1}{2}" ShowTitlePanel="true" VerticalScrollableHeight="300" ShowVerticalScrollBar="true"
                                                        VerticalScrollBarStyle="Standard" ShowHeaderFilterButton="true" ShowGroupFooter="VisibleAlways"
                                                    ...
                                                    <GroupSummary>
                                                        ...
                                                        <dx:ASPxSummaryItem FieldName="Debit" SummaryType="Sum" />
                                                        <dx:ASPxSummaryItem FieldName="Narration" ShowInGroupFooterColumn="Debit" SummaryType="Custom" />
                                                        <dx:ASPxSummaryItem FieldName="ChequeNo." ShowInGroupFooterColumn="Credit" SummaryType="Custom" />
                                                    </GroupSummary>
                                                    <TotalSummary>
                                                        <dx:ASPxSummaryItem FieldName="Credit" SummaryType="Sum" />
                                                        <dx:ASPxSummaryItem FieldName="Debit" SummaryType="Sum" />
                                            ...
                                            <div class="st-content">
                                                ...
                                                <dx:ASPxGridView  Style="margin: 0 auto;
                                                    ...
                                                    <GroupSummary>
                                                        ...
                                                        <dx:ASPxSummaryItem FieldName="Debit" SummaryType="Sum" />
                                                        <dx:ASPxSummaryItem FieldName="Narration" ShowInGroupFooterColumn="Debit" SummaryType="Custom" />
                                                        <dx:ASPxSummaryItem FieldName="Token" ShowInGroupFooterColumn="Credit" SummaryType="Custom" />
                                                    </GroupSummary>
                                                    <SettingsPager Mode="ShowAllRecords">
                                                    </SettingsPager>
                                                    <Columns>
