<%@ Page Language="C#" Culture="en-GB" MasterPageFile="~/Branch.Master" AutoEventWireup="true"
    CodeBehind="OBPvoucher.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.OBPvoucher" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
            ...
            <div class="box_c">
                ...
                <div class="box_c_content">
                            ...
                            <div class="row">
                                ...
                                <div style="display: inline; zoom: 1; text-align: center;">
                                    <div style="margin-left: auto; margin-right: auto; display: table;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: top; padding-left: 6px; text-align: left;">
                                                    ...
                                                    <asp:RangeValidator ID="rvDate" EnableClientScript="false" runat="server" Type="Date"
                                                        ControlToValidate="txtDate" ValidationGroup="Generate" ForeColor="Red" Display="Dynamic"
                                                        ErrorMessage="*"></asp:RangeValidator>
                                                </td>
                                                <td style="vertical-align: top; padding-top: 6px;">
                                                    <asp:Label ID="lblSeries" runat="server" Text="Chit"></asp:Label>
                                                </td>
                                                <td style="vertical-align: top; padding-left: 6px; text-align: left;">
                                                    <asp:DropDownList CssClass="chzn-select" Style="width: 200px !important;" OnSelectedIndexChanged="ddlChits_SelectedIndexChanged"
                                                        TabIndex="58" ValidationGroup="Generate" ID="ddlChits" runat="server" AutoPostBack="true">
                                                    </asp:DropDownList>
                                                    <asp:CompareValidator Display="Dynamic" ValidationGroup="Generate" Operator="NotEqual"
                                                        ControlToValidate="ddlChits" ValueToCompare="--Select--"
                                                        ErrorMessage="*" runat="server"> </asp:CompareValidator>
                                                </td>
                                                <td style="vertical-align: top; padding-top: 6px;">
                                                    <asp:Label ID="Label1" runat="server" Text="Incidential Charges"></asp:Label>
                                                </td>
                                                <td style="vertical-align: top; padding-left: 6px; text-align: left;">
                                                    <asp:TextBox Width="100" TabIndex="3" ValidationGroup="Generate" ID="txtIncidentialCharges"
                                                        CssClass="input-text sp_number" runat="server"></asp:TextBox>
                                                    <asp:RequiredFieldValidator Display="Dynamic" ValidationGroup="Generate" ControlToValidate="txtIncidentialCharges"
                                                ...
                                                <td style="vertical-align: top; padding-left: 6px; text-align: left;">
                                                    <asp:TextBox Width="100" ValidationGroup="Generate" CssClass="input-text sp_number" ID="txtGST"
                                                        runat="server" TabIndex="6"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ValidationGroup="Generate" ControlToValidate="txtGST"
                                                        ID="RequiredFieldValidator7" ErrorMessage="Rquired!!!" runat="server"> </asp:RequiredFieldValidator>                                                
                                                </td>
                                                 </tr>                                                
                                                
                                            <tr>
                                                        <td style="vertical-align: top; padding-top: 6px;">
                                                                 <asp:Label ID="Label2" runat="server" Text="CGST"></asp:Label>
                                                        </td>
                                                      <td style="vertical-align: top; padding-left: 6px; text-align: left;">
                                                          <asp:TextBox ID="txtcgst" runat="server" TabIndex="6"></asp:TextBox>
                                                          </td>
                                                       <td style="vertical-align: top; padding-top: 6px;">
                                                           <asp:Label ID="SGST" runat="server" Text="SGST"></asp:Label>
                                                            </td>
                                                      <td style="vertical-align: top; padding-left: 6px; text-align: left;">
                                                          <asp:TextBox ID="txtsgst" runat="server" TabIndex="6"></asp:TextBox>
                                                          </td>
                                                       <td style="vertical-align: top; padding-top: 6px;">
                                                           <asp:Label ID="IGST" runat="server" Text="IGST"></asp:Label>
                                                           </td>
                                                       <td style="vertical-align: top; padding-left: 6px; text-align: left;">
                                                           <asp:TextBox ID="txtigst" runat="server" TabIndex="6"></asp:TextBox>
                                                           </td>                                                  
                                                </tr>

                                                
                                                <td style="vertical-align: top; padding-top: 6px;">
                                                    <asp:Label ID="lblAppliedDate" runat="server" Text="Applied"></asp:Label>
                                                </td>
                                                <td style="vertical-align: top; padding-left: 6px; text-align: left;">
                                                    <asp:TextBox Width="100" ValidationGroup="Generate" CssClass="input-text maskdate" ID="txtAppliedDate" ToolTip="Ex. 14/10/2015"
                                                        runat="server" TabIndex="6"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ValidationGroup="Generate" ControlToValidate="txtAppliedDate"
                                                        ID="RequiredFieldValidator3" ErrorMessage="Rquired!!!" runat="server"> </asp:RequiredFieldValidator>
                                                    <asp:CompareValidator ForeColor="Red" Type="Date" ID="CompareValidator1" ValidationGroup="Generate"
                                                        ControlToValidate="txtAppliedDate" Display="Dynamic" Operator="DataTypeCheck" runat="server"
                                                        ErrorMessage="Incorrect!!!"></asp:CompareValidator>
                                                    <asp:RangeValidator ID="rvAppied" EnableClientScript="false" runat="server" Type="Date"
                                                        ControlToValidate="txtAppliedDate" ValidationGroup="Generate" ForeColor="Red" Display="Dynamic"
                                                        ErrorMessage="*"></asp:RangeValidator>
                                                </td>
                                                <td style="vertical-align: top; padding-top: 6px;">
                                                    <asp:Label ID="lblGurantorName" runat="server" Text="Gurantor"></asp:Label>
                                                </td>
                                                <td style="vertical-align: top; padding-left: 6px; text-align: left;">
                                                    <asp:TextBox Width="150" ValidationGroup="Generate" CssClass="input-text" ID="txtGurantorName" ToolTip="Ex. xyz"
                                                        runat="server" TabIndex="5"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ValidationGroup="Generate" ControlToValidate="txtGurantorName"
                                                        ID="RequiredFieldValidator2" ErrorMessage="Rquired!!!" runat="server"> </asp:RequiredFieldValidator>
                                                </td>
                                                 <td style="vertical-align: top; padding-top: 6px;">
                                                    <asp:Label ID="lblApprovedDate" runat="server" Text="Approved"></asp:Label>
                                                </td>
                                                <td style="vertical-align: top; padding-left: 6px; text-align: left;">
                                                    <asp:TextBox Width="100" ValidationGroup="Generate" CssClass="input-text maskdate" ID="txtApprovedDate" ToolTip="Ex. 14/10/2015"
                                                        runat="server" TabIndex="6"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ValidationGroup="Generate" ControlToValidate="txtApprovedDate"
                                                        ID="RequiredFieldValidator4" ErrorMessage="Rquired!!!" runat="server"> </asp:RequiredFieldValidator>
                                                    <asp:CompareValidator ForeColor="Red" Type="Date" ID="CompareValidator3" ValidationGroup="Generate"
                                                        ControlToValidate="txtApprovedDate" Display="Dynamic" Operator="DataTypeCheck" runat="server"
                                                        ErrorMessage="Incorrect!!!"></asp:CompareValidator>
                                                    <asp:RangeValidator ID="rvApproved" EnableClientScript="false" runat="server" Type="Date"
                                                        ControlToValidate="txtApprovedDate" ValidationGroup="Generate" ForeColor="Red" Display="Dynamic"
                                                        ErrorMessage="*"></asp:RangeValidator>
                                                </td>
                                                 <td style="vertical-align: top; padding-top: 6px;">
                                                    <asp:Label ID="lblAOsanction" runat="server" Text="AO. #"></asp:Label>
                                                </td>
                                                <td style="vertical-align: top; padding-left: 6px; text-align: left;">
                                                    <asp:TextBox Width="150" ValidationGroup="Generate" CssClass="input-text sp_number" ID="txtAOsanction" ToolTip="Ex. 14/10/2015"
                                                        runat="server" TabIndex="6"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ValidationGroup="Generate" ControlToValidate="txtAOsanction"
                                                        ID="RequiredFieldValidator5" ErrorMessage="Rquired!!!" runat="server"> </asp:RequiredFieldValidator>
                                                </td>
                                        </table>
                                        <br />
                                                ...
                                                <asp:TemplateField HeaderText="Branch">
                                                    <ItemTemplate>
                                                         <table style="border: none;">
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="lblBranch" runat="server" Text='<%# Eval("Branch") %>' Visible="false" />
                                                                    <asp:Label ID="titlebranch" runat="server" Text="Branch"></asp:Label>
                                                                    <asp:DropDownList ID="ddl_Branch" CssClass="chzn-select" Style="width: 200px !important;" ValidationGroup="GrpRow"
                                                                       TabIndex="57" AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddl_Branch_SelectedIndexChanged">
                                                                    </asp:DropDownList>
                                                                </td>
                                                                </tr>
                                                             </table>
                                                ...
                                                <asp:TemplateField HeaderText="Group">
                                                    <ItemTemplate>
                                                         <table style="border: none;">
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="lblGroup" runat="server" Text='<%# Eval("Group") %>' Visible="false" />
                                                                    <asp:Label ID="titlegroup" runat="server" Text="Group"></asp:Label>
                                                                    <asp:DropDownList ID="ddl_group" CssClass="chzn-select" Style="width: 200px !important;" ValidationGroup="GrpRow"
                                                                       TabIndex="57" AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddl_group_SelectedIndexChanged">
                                                                    </asp:DropDownList>
                                                                </td>
                                                                </tr>
                                                             </table>
                                                        ...
                                                        <table style="border: none;">
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <asp:DropDownList CssClass="chzn-select" Style="width: 200px !important;" AutoPostBack="true"
                                                ...
                                                <asp:TemplateField HeaderText="Amount">
                                                    <ItemTemplate>
                                                        <table style="border: none;">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:TextBox Width="80" TabIndex="59" Text='<%#Eval("Amount") %>' ValidationGroup="GrpRow"
                                                        ...
                                                        <table style="border: none;">
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <asp:TextBox TextMode="MultiLine" Height="50" TabIndex="60" Text='<%#Eval("Description") %>' Width="200px"
                                                ...
                                                <asp:TemplateField HeaderText="ChequeNO">
                                                    <ItemTemplate>
                                                        <table style="border: none;">
                                                            <tr>
                                                                <td>
                                                                    <asp:Label Visible='<%# DecideVisibility(Eval("ChequeNO")) %>' ID="lblChequeNO" runat="server"
                                                                        Text="Cheque NO"></asp:Label>
                                                                    <br />
                                                                    <asp:TextBox Width="100" Visible='<%# DecideVisibility(Eval("ChequeNO")) %>' MaxLength="7"
                                                                        TabIndex="60" Text='<%#Eval("ChequeNO") %>' ValidationGroup="GrpRow" CssClass="input-text sp_number"
                                                                        ID="txtChequeNO" runat="server">
                                                                    </asp:TextBox>
                                                                    <asp:RequiredFieldValidator Display="Dynamic" Visible="false" ValidationGroup="GrpRow"
                                                                        ControlToValidate="txtChequeNO" ID="reqChequeNO" ErrorMessage="*" runat="server"> </asp:RequiredFieldValidator>
                                                                </td>
                                                                <td>
                                                                </td>
                                                            </tr>
                                        ...
                                        <div class="box_c_heading cf">
                                            <div class="box_c_ico">
                                                <asp:Image runat="server" ID="img16List1" ImageUrl="pertho_admin_v1.3/img/ico/icSw2/16-List.png"
                                                    AlternateText="" />
                                            </div>
                                            <p>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:ImageButton OnClick="btnAdd_GridGuardiansDebit_RowCommand_click" TabIndex="-1"
                                                                        ID="imgBtnAddDebit" runat="server" Visible="true" CausesValidation="True" Height="24"
                                                                        ValidationGroup="GrpRowDebit" ImageUrl="~/Styles/Image/Images/round_plus_16.png"
                                                                        ToolTip="Add New Transaction" Width="24" />
                                                                </td>
                                                                <td>
                                                        ...
                                                        <table style="border: none;">
                                                            <tr>
                                                                <td style="height: 40px;" align="left">
                                                                    <asp:Label ID="lblamt" runat="server" Text="Amount"></asp:Label>
                                                                    <asp:TextBox Width="150" TabIndex="59" Text='<%#Eval("Amount") %>' ValidationGroup="GrpRowDebit"
                                                            ...
                                                            <tr>
                                                                <td style="height: 40px;">
                                                                    ...
                                                                    <asp:TextBox TextMode="MultiLine" Height="50" TabIndex="60" Text='<%#Eval("Description") %>'
                                                                        ValidationGroup="GrpRowDebit" CssClass="input-text" ID="txtDescriptionDebit"
                                                                        runat="server">
                                                                    </asp:TextBox>
                                                                </td>
                                                                <td style="height: 40px;" align="left">
                    ...
                    <div style="margin: 0 auto;">
                        <br />
                        <asp:Button TabIndex="63" CausesValidation="false" CssClass="GreenyPushButton" Style="display: block;
                            width: 100px; margin: 0 auto;" ID="btnGenerate" OnClick="btnGenerate_Click" Text="Generate"
                            runat="server" />
                    </div>
                </div>
            </div>
    ...
    <asp:Panel Visible="false" ID="pnlpopup" Style="background: #fff; border: 4px solid #ccc;
        ...
        prm.add_endRequest(function () {
          ...
          <%--  Button disable coding--%>     
            function DisableButton() {            
                document.getElementById("<%=btnYes.ClientID %>").disabled = true;
            }
