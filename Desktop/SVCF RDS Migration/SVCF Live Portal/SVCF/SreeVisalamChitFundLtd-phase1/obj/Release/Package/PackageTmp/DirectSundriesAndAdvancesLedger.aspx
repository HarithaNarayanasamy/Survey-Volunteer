<%@ Page Culture="en-GB" Language="C#" MasterPageFile="~/Branch.Master" AutoEventWireup="true"
    CodeBehind="DirectSundriesAndAdvancesLedger.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.DirectSundriesAndAdvancesLedger"
        ...
        <div class="twelve columns">
            <div class="box_c">
                <div class="box_c_heading cf">
                    <p class="sepV_a">
                        Sundries And Advances Ledger</p>
                </div>
            ...
            <asp:DropDownList ID="ddlGroup" Width="150px" CssClass="chzn-select" AutoPostBack="true" OnSelectedIndexChanged="ddlGroup_OnSelectedIndexChanged"
                ...
                <asp:ListItem Text="Head alone" Value="Head alone"></asp:ListItem>
                         ...
                         <div style="display: table-cell; vertical-align: top; padding-top: 10px; padding-right: 5px !important;">
                            ...
                            <div style="display:table-cell; vertical-align:top; padding-top:4px; padding-right:5px !important;">
                                <asp:DropDownList ID="ddladvancenode" Width="150px" CssClass="chzn-select" AutoPostBack="true" OnSelectedIndexChanged="ddladvancenode_OnSelectedIndexChanged"
                                  runat="server"></asp:DropDownList>   

                            </div>
                        <div style="display: table-cell; vertical-align: top; padding-top: 10px; padding-right: 5px !important;">
                                <asp:Label ID="Label4" runat="server" Text="Advance: "></asp:Label>
                            </div>
                            <div style="display:table-cell; vertical-align:top; padding-top:4px; padding-right:5px !important;">
                                <asp:DropDownList ID="ddlSadvance" Width="150px" CssClass="chzn-select" AutoPostBack="true" OnSelectedIndexChanged="ddlSadvance_OnSelectedIndexChanged"
                                  runat="server"></asp:DropDownList>   
                                        ...
                                        <dx:ContentControl ID="ContentControl2" runat="server">
                                            <dx:ASPxGridView Styles-AlternatingRow-BackColor="LightGray" Style="margin: 0 auto;
                                                ...
                                                <TotalSummary>
                                                    ...
                                                    <dx:ASPxSummaryItem FieldName="Node" />           
                                                ...
                                                <SettingsText Title="Advances Ledger" />
                                                ...
                                                <Columns>
                                                    ...
                                                    <dx:GridViewDataColumn FieldName="Debit">
                                                     ...
                                                     <dx:GridViewDataColumn FieldName="Node" Visible="false">
                                                    </dx:GridViewDataColumn>                                                          
                                                </Columns>
                                            ...
                                            <dx:ASPxGridViewExporter ID="gridExportprev" runat="server" GridViewID="grdTemp">
                                              <%--  <Styles>
                                                 ...
                                                 <Styles>
                                                       <Cell Font-Size="9" HorizontalAlign="Left" Wrap="True" Paddings-PaddingBottom="4px" Paddings-PaddingTop="4px" >
                                                         </Cell>
                                            ...
                                            <dx:ASPxGridViewExporter ID="gridExport" runat="server" GridViewID="grid">
                                                ...
                                                <Styles>
                                                   <Cell Font-Size="10" HorizontalAlign="Left" Wrap="True" Paddings-PaddingBottom="4px" Paddings-PaddingTop="4px" >
                                                     ...
                                                     <Footer Font-Size="08" HorizontalAlign="Right" Wrap="True">
                                                     </Footer>                                <Title Font-Size="10" VerticalAlign="Middle" HorizontalAlign="Center" Paddings-PaddingBottom="2px" Paddings-PaddingTop="2px">
                                </Title>
                                                    </Styles>
                                            </dx:ASPxGridViewExporter>
