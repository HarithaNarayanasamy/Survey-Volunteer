<%@ Page Culture="en-GB" Title="SVCF Admin Panel" Language="C#" AutoEventWireup="true" CodeBehind="SudriesAndAdvancesLedgerNew.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.SudriesAndAdvancesLedgerNew" %>
...
<body>
    ...
    <dx:ASPxGridView Style="margin: 0 auto; width: 100%;" OnSummaryDisplayText="ASPxGridView1_SummaryDisplayText" OnCustomSummaryCalculate="ASPxGridView1_OnCustomSummaryCalculate"
        ...
        <Columns>
            ...
            <dx:GridViewDataColumn FieldName="LedgerHead" Caption="Date" CellStyle-HorizontalAlign="Left">
            </dx:GridViewDataColumn>
