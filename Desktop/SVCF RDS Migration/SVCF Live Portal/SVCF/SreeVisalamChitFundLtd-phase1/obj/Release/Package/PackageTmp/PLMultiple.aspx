<%@ Page Language="C#" Culture="en-GB" MasterPageFile="~/Branch.Master" AutoEventWireup="true"
    CodeBehind="PLMultiple.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.PLMultiple"
                                                ...
                                                <%--      <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <table style="border: none;">
                                                            <tr>
                                                                <td>
                                                                    <asp:ImageButton OnClick="btnAdd_GridGuardians_RowCommand_click"   TabIndex="-1" ID="imgBtnAdd" runat="server" CausesValidation="True"
                                                                        CommandName="Add" Height="24" ValidationGroup="GrpRow" ImageUrl="~/Styles/Image/Images/round_plus_16.png"
                                                                        ToolTip="Add New Transaction" Visible='<%# Eval("ShowAddButton")%>' Width="24" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <asp:ImageButton OnClick="btnRemove_GridGuardians_RowCommand_click"     TabIndex="-1" ID="imgBtnRemove" runat="server" CausesValidation="false"
                                                                        CommandName="Remove" Height="24" ImageUrl="~/Styles/Image/Images/round_minus_16.png"
                                                ...
                                                <%--<asp:TemplateField>
                                                    <ItemTemplate>
                                                        <table style="border: none;">
                                                            <tr>
                                                                <td>
                                                                    <asp:ImageButton  TabIndex="-1" ID="imgBtnAddDebit" runat="server" CausesValidation="True"
                                                                        CommandName="AddDebit" Height="24" ValidationGroup="GrpRowDebit" ImageUrl="~/Styles/Image/Images/round_plus_16.png"
                                                                        ToolTip="Add New Transaction" Visible='<%# Eval("ShowAddButton")%>' Width="24" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <asp:ImageButton  TabIndex="-1" ID="imgBtnRemoveDebit" runat="server" CausesValidation="false"
                                                                        CommandName="RemoveDebit" Height="24" ImageUrl="~/Styles/Image/Images/round_minus_16.png"
                                                                        ToolTip="Remove New Transaction" Visible='<%# Eval("ShowRemoveButton")%>' Width="24" />
                                                                </td>
                                                            </tr>
                                                        </table>
