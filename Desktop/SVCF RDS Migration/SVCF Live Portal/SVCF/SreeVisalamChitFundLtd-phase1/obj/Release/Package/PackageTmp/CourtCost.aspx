<%@ Page Title="SVCF Admin Panel" Culture="en-GB" Language="C#" MasterPageFile="~/Branch.Master"
    AutoEventWireup="true" CodeBehind="CourtCost.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.CourtCost" %>
            ...
            <div class="box_c">
                ...
                <div class="box_c_content">
                    <div class="row">
                        <br />
                        <div style="width: 100%;">
                            <asp:Panel runat="server" DefaultButton="btnPayLoan">
                                    ...
                                    <ContentTemplate>
                                        <table style="margin: 0 auto;">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList onchange="clearValidationErrors();" ID="ddlLoan" Width="240px"
                                                        runat="server" CssClass="chzn-select">
                                                    </asp:DropDownList>
                                                    <asp:CompareValidator EnableClientScript="false" ID="CompareValidator4" runat="server"
                                                        ForeColor="Red" ValidationGroup="chit" ControlToValidate="ddlLoan" Display="Dynamic"
                                                        SetFocusOnError="true" ErrorMessage="Select" Operator="NotEqual" ValueToCompare="0"> </asp:CompareValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="vertical-align: top; padding-top: 6px; padding-right: 5px;">
                                                ...
                                                <td>
                                                    <asp:DropDownList onchange="clearValidationErrors();" ID="ddlMember" Width="240px"
                                                        runat="server" CssClass="chzn-select">
                                                    </asp:DropDownList>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox TabIndex="3" runat="server" CssClass="input-text sp_float" ToolTip="Ex. 1000.00"
                                                        placeholder="Amount" ID="txtAmount"></asp:TextBox>
                                                    <asp:RequiredFieldValidator EnableClientScript="false" ID="RFVtxtAmount" ControlToValidate="txtAmount"
                                                        ...
                                                        ForeColor="Red" ErrorMessage="Enter Amount"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="vertical-align: top; padding-top: 6px; padding-right: 5px;">
                                                ...
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator EnableClientScript="false" ID="RequiredFieldValidator5" ErrorMessage="Enter Applied Date"
                                                        ForeColor="Red" ControlToValidate="dxAppliedDate" ValidationGroup="chit" Display="Dynamic"
                                                        runat="server"></asp:RequiredFieldValidator>
                                                    <asp:CompareValidator EnableClientScript="false" ID="CompareValidator2" runat="server" ValidationGroup="chit"
                                                        ForeColor="Red" ControlToValidate="dxAppliedDate" Display="Dynamic" ErrorMessage="Enter Valid Date"
                                                        Operator="DataTypeCheck" Type="Date"> </asp:CompareValidator>
                                                    <asp:RangeValidator EnableClientScript="false" ID="RangeValidator2" runat="server" MaximumValue="31/12/2015"
                                                        ForeColor="Red" MinimumValue="01/01/2013" Type="Date" ControlToValidate="dxAppliedDate"
                                ...
                                <div style="margin: 0px auto; text-align: center;">
                                    <asp:Button TabIndex="11" CausesValidation="true" ValidationGroup="chit" ID="btnPayLoan"
                                        Text="Payment" OnClick="btnPayLoan_Click" CssClass="GreenyPushButton" runat="server" />
