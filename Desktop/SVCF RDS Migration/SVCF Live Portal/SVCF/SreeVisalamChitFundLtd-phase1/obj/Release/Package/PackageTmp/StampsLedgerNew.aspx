<%@ Page Culture="en-GB" Title="SVCF Admin Panel" Language="C#" AutoEventWireup="true" CodeBehind="StampsLedgerNew.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.StampsLedgerNew" %>
...
<body>
    ...
    <dx:ASPxGridView Style="margin: 0 auto; width: 100%;" OnCustomSummaryCalculate="ASPxGridView1_OnCustomSummaryCalculate" OnSummaryDisplayText="ASPxGridView1_SummaryDisplayText"
        ...
        <Columns>
            ...
            <dx:GridViewDataColumn FieldName="LedgerHead" Caption="Head" CellStyle-HorizontalAlign="Left">
            </dx:GridViewDataColumn>
