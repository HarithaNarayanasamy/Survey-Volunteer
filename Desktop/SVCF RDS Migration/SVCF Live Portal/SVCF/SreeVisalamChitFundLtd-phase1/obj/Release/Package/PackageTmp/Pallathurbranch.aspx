<%@ Page Culture="en-GB" Title="" Language="C#" MasterPageFile="~/Branch.Master" AutoEventWireup="true"
     CodeBehind="Pallathurbranch.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.Pallathurbranch" %>
        ...
        <div class="twelve columns">
                                    ...
                                    <ContentCollection>
                                        <dx:ContentControl ID="ContentControl2" runat="server">
                                            ...
                                            <dx:ASPxGridView Styles-AlternatingRow-BackColor="LightGray" Style="margin: 0 auto;
                                                width: 100%;" OnSummaryDisplayText="grid_SummaryDisplayText" OnCustomSummaryCalculate="grid_OnCustomSummaryCalculate"
            ...
            <dx:ASPxSummaryItem FieldName="Credit" SummaryType="Sum" />
             ...
             <dx:ASPxSummaryItem FieldName="Credit" SummaryType="Sum" />
                                                ...
                                                <SettingsText Title="Foreman Chits Ledger" />
                                                <SettingsPager Mode="ShowPager" Position="Bottom">
                                                </SettingsPager>
                                                <Columns>
                                                  <dx:GridViewDataColumn FieldName="Date">
                                                        </dx:GridViewDataColumn>
                                                        <dx:GridViewDataColumn FieldName="Branch" Visible="false" >
                                                        </dx:GridViewDataColumn>
                                            ...
                                            <dx:ASPxGridViewExporter ID="gridExport_pallathur1" runat="server" GridViewID="grid">
                                                <%--<Styles>
