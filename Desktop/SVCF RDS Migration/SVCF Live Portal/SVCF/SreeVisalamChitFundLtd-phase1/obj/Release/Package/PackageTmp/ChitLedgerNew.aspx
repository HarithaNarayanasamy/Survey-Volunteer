<%@ Page Culture="en-GB" Language="C#" Title="SVCF Admin Panel" AutoEventWireup="true" CodeBehind="ChitLedgerNew.aspx.cs"
    Inherits="SreeVisalamChitFundLtd_phase1.ChitLedgerNew" %>
...
<body>
    ...
    <div style="margin-top: -0.5em; margin-bottom: 0.6em;" class="Sub-heading">
        ...
        <div style="display: table-cell; vertical-align: top;padding-top:4px; padding-right: 5px !important;">
            <asp:CheckBox AutoPostBack="true" runat="server" ID="chkKasar" OnCheckedChanged="chkKasar_OnCheckedChanged" Text="Load with Chit Kasar" />
        </div>
    ...
    <dx:ASPxGridView Style="margin: 0 auto; width: 100%;" OnCustomSummaryCalculate="ASPxGridView1_OnCustomSummaryCalculate"
        OnSummaryDisplayText="ASPxGridView1_SummaryDisplayText" ID="grid" ClientInstanceName="grid"
        ...
        <SettingsText Title="Trial Balance of Chits" />
        <TotalSummary>
        ...
        <Columns>
            ...
            <dx:GridViewDataColumn FieldName="LedgerHead" Caption="Chit" CellStyle-HorizontalAlign="Left">
            </dx:GridViewDataColumn>
            <dx:GridViewDataColumn FieldName="Token" CellStyle-HorizontalAlign="Left">
            </dx:GridViewDataColumn>
            
            <dx:GridViewDataColumn FieldName="Narration" FooterCellStyle-HorizontalAlign="Left" CellStyle-HorizontalAlign="Left">
            </dx:GridViewDataColumn>
            <dx:GridViewDataColumn FieldName="Credit" FooterCellStyle-HorizontalAlign="Right" GroupFooterCellStyle-HorizontalAlign="Right">
            </dx:GridViewDataColumn>
            <dx:GridViewDataColumn FieldName="Debit" FooterCellStyle-HorizontalAlign="Right" GroupFooterCellStyle-HorizontalAlign="Right">
            </dx:GridViewDataColumn>
        </Columns>
