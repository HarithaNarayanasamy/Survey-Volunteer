<%@ Page Title="SVCF - Admin Page" Culture="en-GB" Language="C#" MasterPageFile="~/Branch.Master" AutoEventWireup="true"
    CodeBehind="registerwithparticularsofchitdrawalsandprizemoneydisbursement.aspx.cs"
    Inherits="SreeVisalamChitFundLtd_phase1.registerwithparticularsofchitdrawalsandprizemoneydisbursement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <div class="box_c">
        <div class="box_c_heading cf">
            <p class="sepV_a">
                Register with Particulars of Chit Drawals & Prize Money Disbursement</p>
        </div>
        <div class="box_c_content">
            ...
            <div style="width: 100%; margin: 0px auto;">
                <dx:ASPxGridView Styles-AlternatingRow-BackColor="LightGray" Style="margin: 0 auto;
                    ...
                    <SettingsText Title="REGISTER WITH PARTICULARS OF CHIT DRAWALS & PRIZE MONEY DISBURSEMENT" />
                    <Columns>
                        <dx:GridViewDataTextColumn FieldName="Sl. No." Width="8%" VisibleIndex="0" UnboundType="String">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataColumn FieldName="ChitNo" Width="8%" Caption="Chit No.">
                        </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn FieldName="InstNo" Width="8%" Caption="Inst No.">
                        </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn FieldName="DateofAuction" Width="8%" Caption="Auction Date">
                        </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn FieldName="ChitAmount" Width="8%" Caption="Chit Amount">
                        </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn FieldName="NameofthePrizedSubscriber" Width="14%" Caption="Name of the prized Subscriber">
                        </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn FieldName="PrizedMoney" Width="8%" Caption="Prized Money">
                        </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn FieldName="formsentforapprovalon" Width="8%" Caption="Form Sent For Approval On">
                        </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn FieldName="dateofpayment" Width="8%" Caption="Date of Payment">
                        </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn FieldName="GuarantorName" Width="8%" Caption="Guarantor Name">
                        </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn FieldName="Remarks" Width="14%" Caption="Remarks">
                        </dx:GridViewDataColumn>
                    </Columns>
