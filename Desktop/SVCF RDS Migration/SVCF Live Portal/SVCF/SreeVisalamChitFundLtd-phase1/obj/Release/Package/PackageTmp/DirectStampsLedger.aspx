<%@ Page  Culture="en-GB" Language="C#" MasterPageFile="~/Branch.Master" AutoEventWireup="true" CodeBehind="DirectStampsLedger.aspx.cs"
    Inherits="SreeVisalamChitFundLtd_phase1.DirectStampsLedger" Title="Stamps" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <div class="row">
        ...
        <div style="display: table-cell; vertical-align: top;padding-top:4px; padding-right: 5px !important;">
          ...
          <div style="display: table-cell; vertical-align: top; padding-top: 10px; padding-right: 5px !important;">
                                <asp:Label ID="Label4" runat="server" Text="Stamp: "></asp:Label>
                            </div>
                            <div style="display:table-cell; vertical-align:top; padding-top:4px; padding-right:5px !important;">
                                <asp:DropDownList ID="ddlStamp" Width="150px" CssClass="chzn-select" AutoPostBack="true" OnSelectedIndexChanged="ddlStamp_OnSelectedIndexChanged"
...
<Paddings PaddingTop="2px" PaddingBottom="2px"></Paddings>
            ...
            <dx:ASPxSummaryItem FieldName="Narration" SummaryType="Custom" />
                                                ...
                                                <SettingsText Title="Stamps Ledger" />
