<%@ Page Culture="en-GB"  Title="" Language="C#" MasterPageFile="~/Branch.Master" AutoEventWireup="true" CodeBehind="Pallathurbranch3.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.Pallathurbranch3" %>
                                        ...
                                        <dx:ContentControl ID="ContentControl2" runat="server">
                                            <div style="width: 100%; margin: 0 auto;">
                                                ...
                                                <dx:ASPxGridView Styles-AlternatingRow-BackColor="LightGray" Style="margin: 0 auto; width: 100%;"
                                                    ID="gridprev_pallathur3" ClientInstanceName="gridprev_pallathur3" runat="server" Settings-ShowColumnHeaders="false" DataSourceID="AccessDataSource6" OnHtmlRowCreated="gridprev_pallathur3_HtmlRowCreated" OnSummaryDisplayText="gridprev_pallathur3_SummaryDisplayText" OnCustomCallback="gridprev_pallathur3_CustomCallback" OnCustomSummaryCalculate="gridprev_pallathur3_CustomSummaryCalculate">
...
<Cell HorizontalAlign="Left"></Cell>
                                                ...
                                                <dx:ASPxGridViewExporter ID="gridExportprev_Pallathur3" runat="server" GridViewID="grdTemp">
                                                    <Styles>
                                                ...
                                                <dx:ASPxGridView Styles-AlternatingRow-BackColor="LightGray" Style="margin: 0 auto; width: 100%;"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataColumn FieldName="Debit"  CellStyle-CssClass="wd" >
<CellStyle CssClass="wd"></CellStyle>
                                                        </dx:GridViewDataColumn>
                                                    </Columns>
    ...
    PaperKind="A4" Landscape="True"  runat="server" >
                                                ...
                                                <asp:SqlDataSource ID="AccessDataSource6" runat="server" ProviderName="MySql.Data.MySqlClient"></asp:SqlDataSource>
                                            </div>
                                        </dx:ContentControl>
                                    </ContentCollection>
                                </dx:TabPage>
