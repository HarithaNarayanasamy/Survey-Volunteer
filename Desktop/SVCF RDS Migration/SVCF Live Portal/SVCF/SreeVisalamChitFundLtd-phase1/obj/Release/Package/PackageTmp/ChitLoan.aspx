<%@ Page Culture="en-GB" Language="C#" MasterPageFile="~/Branch.Master" AutoEventWireup="true"
    CodeBehind="ChitLoan.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.ChitLoan"
                                        ...
                                        <table style="margin: 0 auto;">
                                            <tr>
                                                <td style="vertical-align: top; padding-top: 6px; padding-right: 5px;">
                                                    <asp:Label ID="label10" runat="server" Text="Type of Loan"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:DropDownList onchange="clearValidationErrors();" ID="ddlLoan" Width="240px"
                                                        runat="server" CssClass="chzn-select" AutoPostBack="true" OnSelectedIndexChanged="ddlLoan_SelectedIndexChanged">
                                                        <asp:ListItem Text="Chit Loan" Value="53"></asp:ListItem>
                                                        <asp:ListItem Text="Employee Loan" Value="55"></asp:ListItem>
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList onchange="clearValidationErrors();" TabIndex="2" ID="ddlTokenNo"
                                                        Width="240px" runat="server" CssClass="chzn-select" AutoPostBack="true">
                                                    </asp:DropDownList>
                                                    <asp:CompareValidator EnableClientScript="false" ID="CompareValidator1" runat="server"
                                                        ForeColor="Red" ValidationGroup="chit" ControlToValidate="ddlTokenNo" Display="Dynamic"
                                                        SetFocusOnError="true" ErrorMessage="Select By Number" Operator="NotEqual" ValueToCompare="--Select--"> </asp:CompareValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="vertical-align: top; padding-top: 6px; padding-right: 5px;">
                                                ...
                                                <td>
                                                    <asp:TextBox TabIndex="3" runat="server" CssClass="input-text sp_float" ToolTip="Ex. 1000.00"
                                                        placeholder="Loan Amount" ID="txtAmount"></asp:TextBox>
                                                    <asp:RequiredFieldValidator EnableClientScript="false" ID="RFVtxtAmount" ControlToValidate="txtAmount"
                                                        ...
                                                        ForeColor="Red" ErrorMessage="Enter Loan Amount"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="vertical-align: top; padding-top: 6px; padding-right: 5px;">
                                                ...
                                                <td>
                                                    ...
                                                    <asp:RangeValidator ID="RangeValidator2" runat="server" MaximumValue="31/12/2015"
