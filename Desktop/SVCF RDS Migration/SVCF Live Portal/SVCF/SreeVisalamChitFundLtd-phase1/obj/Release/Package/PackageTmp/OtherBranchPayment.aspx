<%@ Page Title="SVCF Admin Panel" Culture="en-GB" Language="C#" MasterPageFile="~/Branch.Master"
    AutoEventWireup="true" CodeBehind="OtherBranchPayment.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.OtherBranchPayment" %>
                                    ...
                                    <div style="width: 100%">
                                        <table style="display: table; margin: 0px auto;">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ToolTip="Ex. 1000" placeholder="Payment Number" TabIndex="2" runat="server"
                                                        ID="txtPaymentNumber" CssClass="input-text sp_number" ReadOnly="True"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                   ...
                                                   <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator15" ErrorMessage="Enter Gurantor Number"
                                                        ControlToValidate="txtGurantor" ValidationGroup="pa" Display="Dynamic" runat="server"></asp:RequiredFieldValidator>--%>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtPaymentonDate" TabIndex="8" CssClass="input-text maskdate"
                                                  ...
                                                  <%--  <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ErrorMessage="Enter Payment Date"
                                                    ...
                                                    <asp:RangeValidator ID="RangeValidator1" runat="server" MaximumValue="31/12/2030"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: top;">
                                                    <asp:TextBox TabIndex="9" ID="txtApplyedOn" CssClass="input-text maskdate"
                                                ...
                                                <%--    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ErrorMessage="Enter Applied Date"
                                                    ...
                                                    <asp:CompareValidator ForeColor="Red" Type="Date" ID="CompareValidator3" ValidationGroup="pa"
                                                        ...
                                                        ErrorMessage="Incorrect!!!"></asp:CompareValidator>
                                                    <asp:RangeValidator ID="RangeValidator3" runat="server" MaximumValue="31/12/2030"
                                                        MinimumValue="01/01/2013" Type="Date" ControlToValidate="txtApplyedOn" ValidationGroup="pa"
                                                        ForeColor="Red" Display="Dynamic" ErrorMessage="*"></asp:RangeValidator>--%>
                                                </td>
                                                <td style="vertical-align: top; padding-right: 5px; padding-top: 6px;">
                                        ...
                                        <table style="display: table; margin: 0px auto;">
                                           ...
                                           <%-- <tr>
                                            ...
                                            <tr>
                                                <td style="padding-right: 5px;">
                                                    <asp:Label ID="label" runat="server" Text="GST(Goods and Serivce Tax)"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:TextBox TabIndex="17" CssClass="input-text sp_float" ToolTip="Ex. 1000.00"
                                                        placeholder="GST" ID="txtGST" runat="server"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ControlToValidate="txtGST" Display="Dynamic"
                                                        ValidationGroup="pa" ID="RequiredFieldValidator8" runat="server" ErrorMessage="Enter GST"></asp:RequiredFieldValidator>
                                                </td>
                                                <td>
                                                </td>
                                            </tr>
                                              <tr>
                                                ...
                                                <td rowspan="3">
                                                    <asp:CheckBox ID="RegisterUser" runat="server" Text="Registered" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding-right: 5px;">
