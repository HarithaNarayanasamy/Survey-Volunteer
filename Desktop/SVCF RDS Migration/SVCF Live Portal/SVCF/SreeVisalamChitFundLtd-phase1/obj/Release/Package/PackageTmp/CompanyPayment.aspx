<%@ Page Culture="en-GB" Title="SVCF Admin Panel" Language="C#" MasterPageFile="~/Branch.Master"
    AutoEventWireup="true" CodeBehind="CompanyPayment.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.CompanyPayment" %>
                                    ...
                                    <div style="width: 100%">
                                        <table style="display: table; margin: 0px auto;">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList onchange="clearValidationErrors();" TabIndex="3" Width="240px"
                                                        CssClass="chzn-select" ID="ddlGroupNumber" runat="server" AutoPostBack="true"
                                                        OnSelectedIndexChanged="load_ddlGroupNumber">
                                                    </asp:DropDownList>
                                                ...
                                                <td>
                                                    <asp:DropDownList onchange="clearValidationErrors();" TabIndex="4" AutoPostBack="true"
                                                        OnSelectedIndexChanged="load_ddlMemberName" Width="240px" CssClass="chzn-select"
                                                        ID="ddlMemberName" runat="server">
                                                    </asp:DropDownList>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:RangeValidator ID="rvDate" runat="server" Type="Date" ControlToValidate="txtDate"
                                        ...
                                        <table style="display: table; margin: 0px auto;">
                                            ...
                                            <tr>
                                                <td style="padding-right: 5px; padding-top: 20px;">
                                                    <asp:Label ID="label1" runat="server" Text="Foreman Chit Prized Amount"></asp:Label>
                                                </td>
                                                <td style="padding-right: 5px;">
                                                    <asp:TextBox TabIndex="11" ToolTip="Ex. 1000.00"  ReadOnly="true" placeholder="Foreman Chit Prized Amount"
                                                        CssClass="input-text sp_float" ID="txtPrizedAmount" runat="server"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ControlToValidate="txtPrizedAmount" Display="Dynamic" ValidationGroup="pa"
                                                        ID="RequiredFieldValidator9" runat="server" ErrorMessage="Enter Foreman Chit Prized Amount"></asp:RequiredFieldValidator>
                                                </td>
                                                <td style="padding-right: 5px;">
                                                    <asp:Label ID="label12" runat="server" Text="Commission" Visible="false"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:TextBox TabIndex="12" ToolTip="Ex. 1000.00" placeholder="Commission" Visible="false" CssClass="input-text sp_float"
                                                        ID="txtCommision" ReadOnly="true" runat="server"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                   <asp:Label Text="Foreman Chit Kasar" runat="server" Visible="false"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:TextBox TabIndex="13" ReadOnly="true" Visible="false" ToolTip="Ex. 1000.00" CssClass="input-text sp_float"
                                                        ID="txtKasar" runat="server"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                    ...
                    <asp:Panel CssClass="raised" ID="pnlmsg" runat="server" Visible="false" Width="350px"
                        ...
                        <div class="boxheader">
                            <div style="margin: 0 auto;">
                                <asp:Button Style="margin: 0 auto" CssClass="GreenyPushButton" OnClick="btn_ok" ID="BtnOK"
                                    CausesValidation="false" OnClientClick="clearValidationErrors();" runat="server"
                                    Text="Ok" />
