<%@ Page Title="SVCF - Admin Page" Culture="en-GB" Language="C#" MasterPageFile="~/Branch.Master"
    AutoEventWireup="true" CodeBehind="26carrear.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1._26carrear" %>
                ...
                <div class="box_c_content">
                    <div class="row">
                        ...
                        <div id="printdiv" class="printable">
                            <dx:ASPxGridView OnSummaryDisplayText="ASPxGridView1_SummaryDisplayText" Style="margin: 0 auto;
                                ...
                                <SettingsText Title="Group Arrear" />
                                <SettingsPager Mode="ShowAllRecords">
                                </SettingsPager>
                                <TotalSummary>
                                    
                                    <dx:ASPxSummaryItem DisplayFormat="{0}" FieldName="NPArrear" SummaryType="Sum" />
                                    <dx:ASPxSummaryItem DisplayFormat="{0}" FieldName="PArrear" SummaryType="Sum" />
                                    <dx:ASPxSummaryItem DisplayFormat="{0}" FieldName="TArrear" SummaryType="Sum" />
                                    <dx:ASPxSummaryItem DisplayFormat="{0}" FieldName="total" SummaryType="Sum" />
                                    
                                    <dx:ASPxSummaryItem DisplayFormat="{0}" FieldName="ChitValue" SummaryType="Custom" />
                                </TotalSummary>
                                <Columns>
                                    <%--<dx:GridViewDataColumn Caption="Sl. No.">
                                    </dx:GridViewDataColumn>--%>
                                    <dx:GridViewDataColumn FieldName="GROUPNO" Caption="Group Number" FooterCellStyle-HorizontalAlign="Right"
                                        CellStyle-HorizontalAlign="Right">
                                    </dx:GridViewDataColumn>
                                    <dx:GridViewDataColumn FieldName="ChitValue" Caption="Chit Value" FooterCellStyle-HorizontalAlign="Right"
                                        CellStyle-HorizontalAlign="Right">
                                    </dx:GridViewDataColumn>
                                    <dx:GridViewBandColumn Caption="Arrear">
                                        <Columns>
                                            <dx:GridViewDataColumn FieldName="NPArrear" Caption="Non-Prized" FooterCellStyle-HorizontalAlign="Right"
                                                CellStyle-HorizontalAlign="Right">
                                            </dx:GridViewDataColumn>
                                            <dx:GridViewDataColumn FieldName="PArrear" Caption="Prized" FooterCellStyle-HorizontalAlign="Right"
                                                CellStyle-HorizontalAlign="Right">
                                            </dx:GridViewDataColumn>
                                            <dx:GridViewDataColumn FieldName="TArrear" Caption="Terminated" FooterCellStyle-HorizontalAlign="Right"
                                                CellStyle-HorizontalAlign="Right">
                                            </dx:GridViewDataColumn>
                                            <dx:GridViewDataColumn FieldName="total" Caption="Total" FooterCellStyle-HorizontalAlign="Right"
                                                CellStyle-HorizontalAlign="Right">
                                            </dx:GridViewDataColumn>
                                        </Columns>
