<%@ Page Culture="en-GB" Language="C#" MasterPageFile="~/Branch.Master" AutoEventWireup="true"
    CodeBehind="DirectProfitAndLossAccountLedger.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.DirectProfitAndLossAccountLedger" %>
                    ...
                    <div class="row">
                        <div style="margin-top: -0.5em; margin-bottom: 0.6em;" class="Sub-heading">
                            ...
                            <div style="display: table-cell; vertical-align: top; padding-top: 4px; padding-right: 5px !important;">
                             ...
                             <div style="display: table-cell; vertical-align: top; padding-top: 10px; padding-right: 5px !important;">
                                <asp:Label ID="Label4" runat="server" Text="Profit: "></asp:Label>
                            </div>
                            <div style="display:table-cell; vertical-align:top; padding-top:4px; padding-right:5px !important;">
                                <asp:DropDownList ID="ddlProfit" Width="150px" CssClass="chzn-select" AutoPostBack="true" OnSelectedIndexChanged="ddlProfit_OnSelectedIndexChanged"
                                    ...
                                    <ContentCollection>
                                        <dx:ContentControl ID="ContentControl1" runat="server">
                                            <ul class="overview_list">
                                                <li><a href="#">
                                                    <img src="img/blank.gif" style="background-image: url('http://localhost:3431/pertho_admin_v1.3/img/ico/open/Rs.png')"
                                                        alt="" />
...
<Paddings PaddingRight="3px" PaddingBottom="3px"></Paddings>
                                                         </Cell>
...
<Paddings PaddingTop="2px" PaddingBottom="2px"></Paddings>
                                            ...
                                            <dx:ASPxGridView Styles-AlternatingRow-BackColor="LightGray" Style="margin: 0 auto;
                                                ...
                                                <SettingsText Title="Profit and Loss Ledger" />
