<%@ Page Title="SVCF Admin Page" Culture="en-GB" Language="C#" MasterPageFile="~/Branch.Master"
    AutoEventWireup="true" CodeBehind="courtinsertion.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.courtinsertion" %>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        <table style="margin: 0 auto;">
                                            ...
                                            <tr>
                                                <td style="vertical-align: top; padding-top: 6px; padding-right: 5px;">
                                                    <asp:Label ID="label1" runat="server" Text="Decree Number"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:TextBox runat="server" ID="txtDecreeNumber" CssClass="input-text sp_number"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" EnableClientScript="false"
                                                        ControlToValidate="txtDecreeNumber" ValidationGroup="chit" Display="Dynamic"
                                                        SetFocusOnError="true" runat="server" ForeColor="Red" ErrorMessage="Enter Decree Number"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="vertical-align: top; padding-top: 6px; padding-right: 5px;">
