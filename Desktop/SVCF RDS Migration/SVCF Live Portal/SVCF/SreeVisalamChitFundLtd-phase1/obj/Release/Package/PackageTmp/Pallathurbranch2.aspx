<%@ Page Culture="en-GB" Title="" Language="C#" MasterPageFile="~/Branch.Master" AutoEventWireup="true" CodeBehind="Pallathurbranch2.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.Pallathurbranch2" %>
...
<%@ Register TagPrefix="dx" Namespace="DevExpress.Web.ASPxTabControl" Assembly="DevExpress.Web.v11.1" %>
                    ...
                    <div class="row">
                        <div style="margin-top: -0.5em; margin-bottom: 0.6em;" class="Sub-heading">
                            ...
                            <div style="display: table-cell; vertical-align: top; float: right; padding-right: 5px; text-align: right; margin-top: -35px;">
                             ...
                             <div style="display:table-cell; float: right; padding-left:5px; text-align:right; margin-top:-10px; ">
                                    ...
                                    <ContentCollection>
                                        <dx:ContentControl ID="ContentControl2" runat="server">
                                            <div style="width: 100%; margin: 0 auto;">
                                                ...
                                                <dx:ASPxGridViewExporter ID="gridExportprev_Pallathur2" runat="server" GridViewID="grdTemp">
                                                    <Styles>
                                                ...
                                                <dx:ASPxGridView Styles-AlternatingRow-BackColor="LightGray" Style="margin: 0 auto; width: 100%;"
                                                    OnSummaryDisplayText="grid_SummaryDisplayText" OnCustomSummaryCalculate="grid_OnCustomSummaryCalculate"
                                                ...
                                                <dx:ASPxGridViewExporter ID="gridExport_pallathur2" runat="server" GridViewID="grid">
                                                     <Styles>
