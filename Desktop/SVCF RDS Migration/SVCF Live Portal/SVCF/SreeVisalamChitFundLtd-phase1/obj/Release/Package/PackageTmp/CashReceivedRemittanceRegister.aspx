<%@ Page Culture="en-GB" Language="C#" MasterPageFile="~/Branch.Master" AutoEventWireup="true"
    CodeBehind="CashReceivedRemittanceRegister.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.CashReceivedRemittanceRegister"
    Title="Cash Received Remittance Register" %>
                ...
                <div class="box_c_content">
                    <div class="row">
                        <div style="margin-top: -0.5em; margin-bottom: 0.6em;">
                            <asp:Panel runat="server" DefaultButton="BtnStatisticsGo">
                                ...
                                <div style="display: table-cell; padding-right: 5px;">
                                    <asp:TextBox TabIndex="1" Width="100px" class="input-text maskdate" ID="txtFromDate" runat="server"
                                ...
                                <div style="display: table-cell; padding-right: 5px;">
                                    <asp:TextBox TabIndex="2" Width="100px" class="input-text maskdate" ID="txtToDate" placeholder="To Date"
                                ...
                                <div style="display: table-cell; padding-right: 5px; vertical-align: top;">
                                    <asp:Button ValidationGroup="twelvehead" TabIndex="3" ID="BtnStatisticsGo" CssClass="GreenyPushButton" runat="server" class="btn"
                        ...
                        <dx:ASPxGridView Style="margin: 0 auto; width: 100%;" OnSummaryDisplayText="ASPxGridView1_SummaryDisplayText"
                            ...
                            <SettingsPager Position="TopAndBottom" Mode="ShowPager">
                            </SettingsPager>
                            <Columns>
                                <dx:GridViewDataColumn FieldName="Date" Caption="Date">
                                </dx:GridViewDataColumn>
                                <dx:GridViewDataColumn FieldName="GROUPNO" Caption="Chit Group">
                                </dx:GridViewDataColumn>
                        ...
                        <dx:ASPxGridViewExporter ID="gridExport" runat="server" GridViewID="grid" PaperKind="A4" Landscape="True">
                            <Styles>
