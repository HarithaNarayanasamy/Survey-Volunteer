<%@ Page Title="SVCF - Admin Page" Culture="en-GB" Language="C#" MasterPageFile="~/Branch.Master"
    AutoEventWireup="true" CodeBehind="loaninsertion.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.loaninsertion" %>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        <table style="margin: 0 auto;">
                                            ...
                                            <tr>
                                                <td style="vertical-align: top; padding-top: 6px; padding-right: 5px;">
                                                    <asp:Label ID="label1" runat="server" Text="Loan Number"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:TextBox runat="server" ID="txtLoanNumber" CssClass="input-text sp_number"></asp:TextBox>
                                                    <asp:RequiredFieldValidator EnableClientScript="false" ControlToValidate="txtLoanNumber"
                                                        ValidationGroup="chit" Display="Dynamic" SetFocusOnError="true" runat="server"
                                                        ForeColor="Red" ErrorMessage="Enter Loan Number"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="vertical-align: top; padding-top: 6px; padding-right: 5px;">
                                                ...
                                                <td>
                                                    ...
                                                    <asp:RangeValidator ID="rvDate" runat="server"
                                                        ForeColor="Red"  Type="Date" ControlToValidate="txtDate"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList onchange="clearValidationErrors();" TabIndex="8" Width="240px" ID="ddlMedium" OnSelectedIndexChanged="ddlMedium_SelectedIndexChanged"
                                        ...
                                        <table style="margin: 0 auto;">
                                            <tr>
                                                ...
                                                <td style="padding-right: 5px;">
                                                    ...
                                                    <asp:RequiredFieldValidator ValidationGroup="chit" EnableClientScript="false" Visible="false" ForeColor="Red"
                                                        ID="RFVtxtIfsc" ControlToValidate="txtChequeNo" Display="Dynamic" SetFocusOnError="true"
                                                        runat="server" ErrorMessage="Enter Cheque Number"></asp:RequiredFieldValidator>
                                                </td>
                                                <td style="vertical-align: top; padding-right: 5px; padding-top: 6px;">
