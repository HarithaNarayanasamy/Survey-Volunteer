<%@ Page Title="" Language="C#" MasterPageFile="~/Branch.Master" AutoEventWireup="true" CodeBehind="PartyConfimation.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.PartyConfimation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <div class="row">
                            ...
                            <table id="tble" runat="server" >
                                        <tr>
                                            <td>
                                               ...
                                               <%--<asp:TextBox ID="idTextbox"  class="input-text maskdate" CssClass="twitterStyleTextbox maskdate"  placeholder="To Date" runat ="server"></asp:TextBox>--%>
                                                <asp:TextBox ID="idTextbox"  CssClass="twitterStyleTextbox maskdate"  placeholder="To Date" onchange="CheckDate();" runat ="server"></asp:TextBox>
                                                <asp:RequiredFieldValidator ForeColor="Red" ID="RequiredFieldValidator6" ErrorMessage="Required!!!"
                                                                    ControlToValidate="idTextbox" ValidationGroup="a" Display="Dynamic" runat="server"></asp:RequiredFieldValidator>
                                                                <asp:CompareValidator ForeColor="Red" Type="Date" ID="CompareValidator11" ValidationGroup="a"
                                                                    ControlToValidate="idTextbox" Display="Dynamic" Operator="DataTypeCheck" runat="server"
                                            ...
                                            <td>
                                                ...
                                                <asp:Label ID="lblGroupname" Text="Group Name" runat="server"></asp:Label><br />
                                                 <asp:DropDownList ID="listGroup" TabIndex="7" runat="server" OnSelectedIndexChanged="id_oNSelected"  AutoPostBack="true" CssClass="chzn-select" Width="300px">
                                                </asp:DropDownList>
                                           
                                                <asp:Label ID="Label2" Text="Value" runat="server" Visible="false"></asp:Label><br />
                                                 <asp:DropDownList ID="listvalue" TabIndex="7" runat="server" OnChange="ListTkn();" CssClass="chzn-select" Width="300px" Visible="false">
                                                </asp:DropDownList>
                                            </td>
                                            <td>
     ...
     <script type="text/javascript">
        function checkdate(txt) {
            ...
            //  alert('mm');
            $('#<%=idTextbox.ClientID%>').val(txt.value);
        }
    ...
    <script type="text/javascript">
        function CheckDate() {
            var inputDate = $('#<%=idTextbox.ClientID %>').val();
            ...
            if (Reg_Expression.test(inputDate)) {
                ...
                if ((dDate.getFullYear() == nYear) && (dDate.getMonth() == nMonth - 1) && (dDate.getDate() == nDay)) {
                    ...
                    document.getElementById('<%=idTextbox.ClientID %>').value = "";
