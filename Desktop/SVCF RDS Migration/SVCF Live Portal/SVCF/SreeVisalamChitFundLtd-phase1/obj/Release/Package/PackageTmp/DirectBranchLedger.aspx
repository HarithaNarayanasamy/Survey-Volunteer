<%@ Page Culture="en-GB" Language="C#" MasterPageFile="~/Branch.Master" AutoEventWireup="true"
    CodeBehind="DirectBranchLedger.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.DirectBranchLedger"
    Title="Branch Ledger New" %>
...
<%@ Register Assembly="DevExpress.Web.v11.1" Namespace="DevExpress.Web.ASPxGlobalEvents" TagPrefix="dx" %>
                    ...
                    <div class="row">
                        <div style="margin-top: -0.5em; margin-bottom: 0.6em;" class="Sub-heading">
                            ...
                            <div style="display: table-cell; vertical-align: top; padding-top: 5px; padding-right: 5px !important;">
                                <asp:TextBox class="input-text maskdate" Width="100px" ID="dateFromConsolidated"
                            ...
                            <div style="display: table-cell; vertical-align: top; padding-top: 5px; padding-right: 5px !important;">
                                <asp:TextBox class="input-text maskdate" Width="100px" ID="dateToConsolidated" placeholder="To Date"
                            ...
                            <div style="display: table-cell; vertical-align: top; padding-top: 4px; padding-right: 5px !important;">
                                <asp:DropDownList ID="ddlGroup" Width="150px" CssClass="chzn-select" AutoPostBack="true"
                                    ...
                                    <asp:ListItem Text="Date Alone" Value="Branch and Date"></asp:ListItem>
                            ...
                            <div style="display: table-cell; vertical-align: top; padding-top: 4px; padding-right: 5px !important;">
                                <asp:DropDownList ID="ddlbranch" Width="150px" CssClass="chzn-select" AutoPostBack="true" OnSelectedIndexChanged="ddlbranch_OnSelectedIndexChanged"
                                    runat="server">
                                </asp:DropDownList>
                            </div>


                            <div style="display: table-cell; vertical-align: top; float: right; padding-right: 5px; text-align: right; margin-top: -35px;">
                                ...
                                <div style="display:table-cell; float:right; padding-left:5px; text-align:right; margin-top:-0px; ">
                                      <dx:ASPxButton ID="ASPxButton1" Text="ExportExcel"  runat="server" Visible="true"
                        ...
                        <dx:ASPxPageControl Width="100%" ID="carTabPage" TabAlign="Left" TabPosition="Top"
                            ActivateTabPageAction="Click" runat="server" ActiveTabIndex="1" EnableHierarchyRecreation="True">
                            <TabPages>
                                <dx:TabPage Text="Consolidated view">
                                    <ContentCollection>
                                        <dx:ContentControl ID="ContentControl1" runat="server">
                                            <asp:Panel ID="Panel_P1" runat="server">
                                                <asp:Label runat="server" ID="Pallathur_1" Text="Pallathur-I" class="ov_text"></asp:Label>
                                                <br />
                                                <ul class="overview_list">
                                                    <li><a href="#">
                                                        <img src="img/blank.gif" style="background-image: url(pertho_admin_v1.3/img/ico/open/Rs.png)"
                                                            alt="" />
                                                        <asp:Label runat="server" ID="lblCrAmount_pallathur1" Text="0.00" class="ov_nb"></asp:Label>
                                                        <span class="ov_text">Cr Amount</span> </a></li>
                                                    <li><a href="#">
                                                        <img src="img/blank.gif" style="background-image: url(pertho_admin_v1.3/img/ico/open/Rs.png)"
                                                            alt="" />
                                                        <asp:Label runat="server" ID="lblDrAmount_pallathur1" Text="0.00" class="ov_nb"></asp:Label>
                                                        <span class="ov_text">Dr Amount</span> </a></li>
                                                    <li><a href="#">
                                                        <img src="img/blank.gif" style="background-image: url(pertho_admin_v1.3/img/ico/open/Rs.png)"
                                                            alt="" />
                                                        <asp:Label runat="server" ID="lblCrBalance_pallathur1" Text="0.00" class="ov_nb"></asp:Label>
                                                        <span class="ov_text">Cr Balance</span> </a></li>
                                                    <li><a href="#">
                                                        <img src="img/blank.gif" style="background-image: url(pertho_admin_v1.3/img/ico/open/Rs.png)"
                                                            alt="" />
                                                        <asp:Label runat="server" ID="lblDrBalance_pallathur1" Text="0.00" class="ov_nb"></asp:Label>
                                                        <span class="ov_text">Dr Balance</span> </a></li>
                                                </ul>
                                            </asp:Panel>
                                            <asp:Panel ID="Panel_P2" runat="server">
                                                <asp:Label runat="server" ID="Pallathur_2" Text="Pallathur-II" class="ov_text"></asp:Label>
                                                <br />
                                                <ul class="overview_list">
                                                    <li><a href="#">
                                                        <img src="img/blank.gif" style="background-image: url(pertho_admin_v1.3/img/ico/open/Rs.png)"
                                                            alt="" />
                                                        <asp:Label runat="server" ID="lblCrAmount_pallathur2" Text="0.00" class="ov_nb"></asp:Label>
                                                        <span class="ov_text">Cr Amount</span> </a></li>
                                                    <li><a href="#">
                                                        <img src="img/blank.gif" style="background-image: url(pertho_admin_v1.3/img/ico/open/Rs.png)"
                                                            alt="" />
                                                        <asp:Label runat="server" ID="lblDrAmount_pallathur2" Text="0.00" class="ov_nb"></asp:Label>
                                                        <span class="ov_text">Dr Amount</span> </a></li>
                                                    <li><a href="#">
                                                        <img src="img/blank.gif" style="background-image: url(pertho_admin_v1.3/img/ico/open/Rs.png)"
                                                            alt="" />
                                                        <asp:Label runat="server" ID="lblCrBalance_pallathur2" Text="0.00" class="ov_nb"></asp:Label>
                                                        <span class="ov_text">Cr Balance</span> </a></li>
                                                    <li><a href="#">
                                                        <img src="img/blank.gif" style="background-image: url(pertho_admin_v1.3/img/ico/open/Rs.png)"
                                                            alt="" />
                                                        <asp:Label runat="server" ID="lblDrBalance_pallathur2" Text="0.00" class="ov_nb"></asp:Label>
                                                        <span class="ov_text">Dr Balance</span> </a></li>
                                                </ul>
                                            </asp:Panel>
                                            <asp:Panel ID="Panel_P3" runat="server">
                                                <asp:Label runat="server" ID="Pallathur_3" Text="Pallathur-III" class="ov_text"></asp:Label>
                                                <br />
                                                <ul class="overview_list">
                                                    <li><a href="#">
                                                        <img src="img/blank.gif" style="background-image: url(pertho_admin_v1.3/img/ico/open/Rs.png)"
                                    ...
                                    <ContentCollection>
                                        <dx:ContentControl ID="ContentControl2" runat="server">
                                            <div style="width: 100%; margin: 0 auto;">
                                                ...
                                                <dx:ASPxGridView Styles-AlternatingRow-BackColor="LightGray" Style="margin: 0 auto; width: 100%;"
                                                    ID="gridprev_pallathur1" ClientInstanceName="gridprev_pallathur1" runat="server" Settings-ShowColumnHeaders="false" DataSourceID="AccessDataSource4" OnHtmlRowCreated="gridprev_pallathur1_HtmlRowCreated" OnSummaryDisplayText="gridprev_pallathur1_SummaryDisplayText" OnCustomCallback="gridprev_pallathur1_CustomCallback" OnCustomSummaryCalculate="gridprev_pallathur1_CustomSummaryCalculate">
                                                    ...
                                                    <SettingsText Title="Branch Ledger" />
                                                ...
                                                <dx:ASPxGridView ID="grdTemp1" runat="server" Styles-AlternatingRow-BackColor="LightGray" ClientInstanceName="grdTemp1" Style="margin: 0 auto; width: 100%;">
                                                    <SettingsPager Visible="false" Position="Bottom" />
                                                    <ClientSideEvents Init="OnInit" EndCallback="OnEndCallback" />
                                                    <Columns>
                                                ...
                                                <dx:ASPxGridViewExporter ID="gridExportprev_pallathur1" runat="server" GridViewID="grdTemp1">
                                                    <Styles>
                                                ...
                                                <dx:ASPxGridView Styles-AlternatingRow-BackColor="LightGray" Style="margin: 0 auto; width: 100%;"
                                                    OnSummaryDisplayText="grid_pallathur1_SummaryDisplayText" OnCustomSummaryCalculate="grid_pallathur1_OnCustomSummaryCalculate"
                                                    ID="grid_pallathur1" ClientInstanceName="grid_pallathur1" runat="server" DataSourceID="AccessDataSource3">
                                                    <Settings GroupFormat="{1}{2}" VerticalScrollableHeight="303" ShowTitlePanel="true"
                                                        ShowFilterRowMenu="true" ShowVerticalScrollBar="true" VerticalScrollBarStyle="Standard"
                                                        ShowHeaderFilterButton="true" ShowFooter="true" ShowGroupFooter="VisibleAlways"
                                                    ...
                                                    <ClientSideEvents EndCallback="function(s,e){gridprev_pallathur1.PerformCallback();}" />
                                                </dx:ASPxGridView>
                                                <dx:ASPxGridViewExporter ID="gridExport_pallathur1" runat="server" GridViewID="grid_pallathur1">
                                                    <Styles>

                                                        <%--    <Cell Font-Size="10" HorizontalAlign="Left" Wrap="True" Paddings-PaddingBottom="4px" Paddings-PaddingTop="4px" >--%>
                                                        <Cell Font-Size="8" HorizontalAlign="Left" Wrap="True" Paddings-PaddingBottom="4px" Paddings-PaddingTop="4px">
                                                        </Cell>
                                                        <Footer Font-Size="09" HorizontalAlign="Right" Wrap="True">
                                                        </Footer>

                                                        <Title Font-Size="8" VerticalAlign="Middle" HorizontalAlign="Center" Paddings-PaddingBottom="2px" Paddings-PaddingTop="2px"></Title>
                                                    </Styles>
                                                </dx:ASPxGridViewExporter>

                                                <dx:ASPxGridView Styles-AlternatingRow-BackColor="LightGray" Style="margin: 0 auto; width: 100%;"
                                                    ID="gridprev_pallathur2" ClientInstanceName="gridprev_pallathur2" runat="server" Settings-ShowColumnHeaders="false" DataSourceID="AccessDataSource6" OnHtmlRowCreated="gridprev_pallathur2_HtmlRowCreated" OnSummaryDisplayText="gridprev_pallathur2_SummaryDisplayText" OnCustomCallback="gridprev_pallathur2_CustomCallback" OnCustomSummaryCalculate="gridprev_pallathur2_CustomSummaryCalculate">
                                                    <Settings GroupFormat="{1}{2}" ShowFilterRowMenu="false"
                                                        ShowHeaderFilterButton="false" ShowFooter="true" ShowGroupFooter="VisibleAlways"
                                                        ShowGroupPanel="false" ShowGroupedColumns="true" ShowFilterBar="Hidden" ShowFilterRow="false" />
                                                    <TotalSummary>
                                                ...
                                                <dx:ASPxGridView ID="grdTemp2" runat="server" Styles-AlternatingRow-BackColor="LightGray" ClientInstanceName="grdTemp2" Visible="false" Style="margin: 0 auto; width: 100%;">
                                                    <SettingsPager Visible="false" Position="Bottom" />
                                                    <ClientSideEvents Init="OnInit" EndCallback="OnEndCallback" />
                                                    <Columns>
                                                        <dx:GridViewDataColumn FieldName="Title">
                                                ...
                                                <dx:ASPxGridViewExporter ID="gridExportprev_Pallathur2" runat="server" GridViewID="grdTemp2">
                                                    <Styles>
                                                        <Header Wrap="True" HorizontalAlign="Center">
                                                        </Header>
                                                        <Cell HorizontalAlign="Left" Wrap="True">
                                                ...
                                                <dx:ASPxGridView Styles-AlternatingRow-BackColor="LightGray" Style="margin: 0 auto; width: 100%;"
                                                    OnSummaryDisplayText="grid_pallathur2_SummaryDisplayText" OnCustomSummaryCalculate="grid_pallathur2_OnCustomSummaryCalculate"
                                                    ID="grid_pallathur2" ClientInstanceName="grid_pallathur2" runat="server" DataSourceID="AccessDataSource5">
                                                    <Settings GroupFormat="{1}{2}" VerticalScrollableHeight="303" ShowTitlePanel="true"
                                                        ShowFilterRowMenu="true" ShowVerticalScrollBar="true" VerticalScrollBarStyle="Standard"
                                                        ShowHeaderFilterButton="true" ShowFooter="true" ShowGroupFooter="VisibleAlways"
                                                        ShowGroupPanel="false" ShowGroupedColumns="true" ShowFilterBar="Visible" ShowFilterRow="true" />
                                                    ...
                                                    <ClientSideEvents EndCallback="function(s,e){gridprev_pallathur2.PerformCallback();}" />
                                                </dx:ASPxGridView>
                                                <dx:ASPxGridViewExporter ID="gridExport_pallathur2" runat="server" GridViewID="grid_pallathur2">
                                                    <Styles>
                                                        <%--<Cell Font-Size="10" HorizontalAlign="Left" Wrap="True" Paddings-PaddingBottom="4px" Paddings-PaddingTop="4px" >
                                                         </Cell>--%>
                                                        <Cell Font-Size="10" HorizontalAlign="Left" Wrap="True">
                                                        </Cell>
                                                        <Footer Font-Size="09" HorizontalAlign="Right" Wrap="True">
                                                        </Footer>

                                                        <Title Font-Size="10" VerticalAlign="Middle" HorizontalAlign="Center" Paddings-PaddingBottom="2px" Paddings-PaddingTop="2px"></Title>
                                                    </Styles>
                                                </dx:ASPxGridViewExporter>
                                                <div id="printdiv" class="printable">
                                                    <dx:ASPxGridView Styles-AlternatingRow-BackColor="LightGray" Style="margin: 0 auto; width: 100%;"
                                                        ID="gridprev" ClientInstanceName="gridprev" runat="server" Settings-ShowColumnHeaders="false" DataSourceID="AccessDataSource2"
                                                        OnHtmlRowCreated="gridprev_HtmlRowCreated" OnSummaryDisplayText="gridprev_SummaryDisplayText" OnCustomCallback="gridprev_CustomCallback" OnCustomSummaryCalculate="gridprev_CustomSummaryCalculate">
                                                        <Settings GroupFormat="{1}{2}" ShowFilterRowMenu="false"
                                                            ShowHeaderFilterButton="false" ShowFooter="true" ShowGroupFooter="VisibleAlways"
                                                            ShowGroupPanel="false" ShowGroupedColumns="true" ShowFilterBar="Hidden" ShowFilterRow="false" />
                                                    ...
                                                    <dx:ASPxGridView Styles-AlternatingRow-BackColor="LightGray" Style="margin: 0 auto; width: 100%;" EnableRowsCache="False"
                                                        OnSummaryDisplayText="ASPxGridView1_SummaryDisplayText" OnCustomSummaryCalculate="ASPxGridView1_OnCustomSummaryCalculate" KeyFieldName="inccolumn"
                            ...
                            <%--<Styles Cell-HorizontalAlign="Left" Header-Wrap="True" CommandColumn-Paddings-Padding="10"
                                Header-HorizontalAlign="Center" Header-VerticalAlign="Middle">
                                                        ...
                                                        <TotalSummary>
                                                            ...
                                                            <dx:ASPxSummaryItem FieldName="Debit" SummaryType="Sum" />
                                                            <dx:ASPxSummaryItem FieldName="Narration" SummaryType="Custom" />
                                                            <dx:ASPxSummaryItem FieldName="LedgerHead" SummaryType="Custom" />
                                                        </TotalSummary>
                                                        <GroupSummary>
                                                            <dx:ASPxSummaryItem FieldName="Credit" SummaryType="Sum" />
                                                            <dx:ASPxSummaryItem FieldName="Debit" SummaryType="Sum" />
                                                   ...
                                                   <%--     <SettingsPager Mode="ShowPager" Position="Bottom">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dx:GridViewDataColumn FieldName="Debit">
                                                                      ...
                                                                      <SettingsPager Mode="ShowPager" Position="Bottom" PageSize="10">
                                                        </SettingsPager>
                                                        <Styles Footer-HorizontalAlign="Left" Cell-HorizontalAlign="Left" Header-VerticalAlign="Middle"
                                                            Header-HorizontalAlign="Center" Header-Wrap="True">
                                                ...
                                                <asp:SqlDataSource runat="server" ID="AccessDataSource3" ProviderName="MySql.Data.MySqlClient"
                                                    SelectCommand=" " />
                                                <asp:SqlDataSource runat="server" ID="AccessDataSource4" ProviderName="MySql.Data.MySqlClient"
                                                    SelectCommand=" " />
