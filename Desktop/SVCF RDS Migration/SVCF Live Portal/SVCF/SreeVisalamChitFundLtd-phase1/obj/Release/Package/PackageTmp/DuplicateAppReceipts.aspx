        ...
        <div style="display: table-cell; vertical-align: top; padding-top: 8px;">
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlBranch" runat="server" CssClass="chzn-select" Width="200px" AutoPostBack="true" OnSelectedIndexChanged="ddlBranch_SelectedIndexChanged">
                    </asp:DropDownList>
                    </td>
                    <td></td>
                    <td>
                        <asp:Label ID="lblMoneyCollector" runat="server" Text="Select MoneyCollector"></asp:Label>
                    </td>
                    <td>
                        ...
                        <asp:GridView ID="gridReceipts" BorderStyle="Solid" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Receipt PDF" >
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkPdf" runat="server" Text="Download" CommandArgument='<%# Eval("AppReceiptno") %>' CommandName="Download"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
