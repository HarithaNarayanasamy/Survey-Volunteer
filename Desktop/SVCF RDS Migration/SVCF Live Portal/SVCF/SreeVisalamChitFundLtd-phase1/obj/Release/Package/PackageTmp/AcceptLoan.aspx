<%@ Page Title="SVCF Admin Panel" Culture="en-GB" Language="C#" MasterPageFile="~/Branch.Master"
    AutoEventWireup="true" CodeBehind="AcceptLoan.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.AcceptLoan" %>
    ...
    <div class="row">
                        ...
                        <div class="row display">
                            <div style="margin: 0px auto;">
                                <div style="display: table-cell; vertical-align: top; padding-top: 10px; padding-right: 5px !important;">
                                    <asp:Label ID="Label1" Text="Status " runat="server"> </asp:Label>
                                </div>
                                ...
                                <div style="display: table-cell; vertical-align: top; padding-top: 5px; padding-right: 5px !important;">
                                    <asp:TextBox ID="txtDate" CssClass="input-text maskdate" Width="100px" runat="server"> </asp:TextBox>
                                </div>
                                <div style="display: table-cell; vertical-align: top; padding-top: 5px; padding-right: 5px !important;">
                            ...
                            <div class="twelve columns centered">
                                <div style="margin: 0px auto; width:100%;overflow:auto !important;">
                                    <asp:GridView OnRowDataBound="GridView1_OnRowDataBound" ID="GridView1" CssClass="aspxtable"
                                        runat="server" AutoGenerateColumns="false" GridLines="Vertical" DataKeyNames="GroupID,MemberID,BranchID,B_Name,loan,ID,Name,loantype,LoanHeadID,LoanAmount,ApplyedOn,Narration,Trans_Medium,Flag,BankHeadId,aid"
                                        Style="margin: 0px auto; display: table;" Width="100%" ShowFooter="True">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    ...
                                                    <%--<asp:ImageButton Visible="false" Height="20px" ToolTip="Undo" Width="30px" ID="btnundo"
                                                        runat="server" CausesValidation="false" OnClick="btnundo_OnClick" ImageUrl="~/Images/Undo-icon.png" />--%>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField ItemStyle-Wrap="true" HeaderText="loan" DataField="loan" />
                                            <asp:BoundField ItemStyle-Wrap="true" HeaderText="Token" DataField="ID" />
                                            <asp:BoundField ItemStyle-Wrap="true" HeaderText="Name" DataField="Name" />
                                            <%--<asp:BoundField ItemStyle-Wrap="true" HeaderText="Member ID" DataField="MemberIDNEW" />--%>
                                            <%--<asp:BoundField ItemStyle-Wrap="true" HeaderText="Name" DataField="Name" />--%>
                                            <asp:BoundField ItemStyle-Wrap="true" HeaderText="Branch Name" DataField="B_Name" />
                                            <asp:BoundField ItemStyle-Wrap="true" HeaderText="Loan Amount" DataField="LoanAmount" />
                                            <asp:BoundField ItemStyle-Wrap="true" HeaderText="Applyed Date" DataField="ApplyedOn" />
                                            <asp:BoundField ItemStyle-Wrap="true" HeaderText="Narration" DataField="Narration" />
                                            
                                            
                                            <%--<asp:BoundField ItemStyle-Wrap="true" HeaderText="Cheque Number" DataField="ChequeNo" />
                                            <asp:BoundField ItemStyle-Wrap="true" HeaderText="Bank Name" DataField="BankName" />--%>
                                        </Columns>
        ...
        <asp:Panel CssClass="raised" ID="pnlView" runat="server" Visible="false" Width="600px"
            ...
            <div id="Div3" style="max-height: 480px; min-height: 200px; overflow: auto; width: 100%;">
                ...
                <asp:GridView runat="server" CssClass="aspxtable" ID="gridOverview" AutoGenerateColumns="true"></asp:GridView>
                <asp:Label runat="server" ID="lbNoRecords"></asp:Label>
            </div>
            <div class="boxheader">
                ...
                <table>
                    <tr style="text-align: center;" align="center">
                        <td style="vertical-align: top; padding-right: 10px; padding-left: 100px; padding-top: 5px;">
                            <asp:Label ID="Label2" runat="server" Text="Loan Number : "></asp:Label>
                        </td>
                        <td>
