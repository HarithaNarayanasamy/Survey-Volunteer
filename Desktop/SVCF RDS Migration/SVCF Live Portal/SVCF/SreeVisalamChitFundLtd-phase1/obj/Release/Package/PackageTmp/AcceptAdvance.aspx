<%@ Page Title="SVCF Admin Panel" EnableViewState="true" Culture="en-GB" Language="C#" MasterPageFile="~/Branch.Master"
    AutoEventWireup="true" CodeBehind="AcceptAdvance.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.AcceptAdvance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
                                    ...
                                    <div class="twelve columns centered">
                                        <div style="margin: 0px auto; display: table;">
                                            <asp:GridView OnRowDataBound="GridView1_OnRowDataBound" ID="GridView1" CssClass="aspxtable"
                                                runat="server" AutoGenerateColumns="false" GridLines="Vertical" DataKeyNames="BranchID,B_Name,Head,Child,HeadID,Amount,ApplyedOn,Narration,sno"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField HeaderText="Child" DataField="Child" />
    ...
    <asp:Panel CssClass="raised" ID="pnlView" runat="server" Visible="false" Width="600px"
        ...
        <div id="Div3" style="max-height: 500px; min-height: 200px; overflow: auto; width: 100%;">
            <br /><asp:Label runat="server" Text="If you want to approve, then click Accept else click Reject" ID="lbConte"></asp:Label>
    ...
    <asp:Panel CssClass="raised" ID="PnlAccept" runat="server" Visible="false" Width="600px"
        ...
        <div id="Div2" style="max-height: 400px; text-align: center; min-height: 200px; overflow: auto;
            ...
            <br />
            <asp:Label ID="lblAccept" runat="server" Text="Advance Number"> </asp:Label>
            <br />
            <br />
            <br />
            <table>
                <tr style="text-align: center;" align="center">
                    <td style="vertical-align: top; padding-right: 10px; padding-left: 100px; padding-top: 5px;">
                        <asp:Label runat="server" Text="Advance Number : "></asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtAccept" runat="server" CssClass="sp_number input-text"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfv1" runat="server" SetFocusOnError="true" ControlToValidate="txtAccept"
                            ErrorMessage="Enter Advance Number" ValidationGroup="Rej"> </asp:RequiredFieldValidator>
                    </td>
                </tr>
            </table>
            <br />
