<%@ Page Title="SVCF - Admin Page" Culture="en-GB" Language="C#" MasterPageFile="~/Branch.Master"
    AutoEventWireup="true" CodeBehind="crr.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.crr" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <div class="row">
                                                ...
                                                <table cellspacing="5" width="100%">
                                                    <tr>
                                                        ...
                                                        <td style="padding: 5px !important;">
                                                            ...
                                                            <asp:CompareValidator EnableClientScript="false" ID="CVddlReceiptSeries" ValueToCompare="--Select--"
                                                                ForeColor="Red" ControlToValidate="ddlReceiptSeries" Display="Static" Operator="NotEqual"
                                                                SetFocusOnError="true" ValidationGroup="a" runat="server" ErrorMessage="*"></asp:CompareValidator>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td style="padding: 5px !important;">
                                                            <asp:Label ID="Label3" runat="server" Text="Collected By"></asp:Label>
                                                            <br />
                                                            <asp:DropDownList Width="140px" CausesValidation="false" ID="ddlCollected" runat="server"
                                                                TabIndex="4" ValidationGroup="a" CssClass="chzn-select">
                                                            </asp:DropDownList>
                                                            <asp:CompareValidator Style="margin-top: -2px;" EnableClientScript="false" ID="CompareValidator2"
                                                                ValueToCompare="--Select--" ValidationGroup="a" ControlToValidate="ddlCollected"
                                                                ForeColor="Red" SetFocusOnError="true" Display="Static" Operator="NotEqual" runat="server"
                                                        ...
                                                        <td style="padding: 5px !important;">
                                                            ...
                                                            <asp:TextBox ID="txtTotalAmount" CausesValidation="false" runat="server" TabIndex="5"
                                                                Width="120" ValidationGroup="a" CssClass="twitterStyleTextbox sp_currency" autocomplete="off"></asp:TextBox>
                                                            ...
                                                            <asp:RegularExpressionValidator EnableClientScript="false" ID="REVtxtTotalAmount"
                                                                ForeColor="Red" runat="server" Display="Dynamic" SetFocusOnError="true" ValidationExpression="^\d+(\.\d{1,2})?$"
                                                        ...
                                                        <td style="padding: 5px !important;">
                                                            ...
                                                            <asp:RangeValidator ID="rvDate" EnableClientScript="false" runat="server" Type="Date"
                                                                    ControlToValidate="txtReceivedDate" ValidationGroup="a" ForeColor="Red" Display="Dynamic"
        ...
        ProviderName="MySql.Data.MySqlClient" SelectCommand="select  11 as RootID,'--Select--' as Head,0000 as NodeID union SELECT * FROM svcf.view_parent where RootID=11" />--%>
                                            <asp:GridView CssClass="Trans twelve columns" ID="GridView1" AutoGenerateColumns="False"
                                                BorderStyle="Solid" CellSpacing="11" Font-Names="Verdana" ForeColor="#333333"
                                                    ...
                                                    <asp:TemplateField HeaderText="Member Name">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:CompareValidator EnableClientScript="false" ID="CVddlGroupNo" runat="server"
                                                                ForeColor="Red" ControlToValidate="ddlGroupNo" Display="Static" SetFocusOnError="true"
                                                                ErrorMessage="*" Operator="NotEqual" ValidationGroup="GrpRow" ValueToCompare="--Select--"> </asp:CompareValidator>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Token">
                                                        <ItemTemplate>
                                                            <asp:DropDownList TabIndex="9" CausesValidation="false" ID="ddlMemberName" ValidationGroup="GrpRow"
                                                                CssClass="chzn-select" runat="server">
                                                            </asp:DropDownList>
                                                            <asp:CompareValidator EnableClientScript="false" ID="CVddlMemberName" runat="server"
                                                                ForeColor="Red" ControlToValidate="ddlMemberName" Display="Static" SetFocusOnError="true"
                                                                ErrorMessage="*" Operator="NotEqual" ValidationGroup="GrpRow" ValueToCompare="--Select--"> </asp:CompareValidator>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
