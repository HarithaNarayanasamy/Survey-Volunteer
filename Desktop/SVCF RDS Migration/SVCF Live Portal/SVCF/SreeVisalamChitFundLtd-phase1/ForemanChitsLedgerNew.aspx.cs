...
{
    public partial class ForemanChitsLedgerNew : System.Web.UI.Page
    {
        #region Object
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                select();
                ApplyLayout(1);
                grid.SettingsText.Title = "Trial Balance of Foreman Chits from " + txtFromDate.Text + " to " + txtToDate.Text;
        ...
        protected void ASPxGridView1_SummaryDisplayText(object sender, ASPxGridViewSummaryDisplayTextEventArgs e)
        {
            ...
            {
                // e.Text = "Cr." + string.Format(hi, "{0:c}", parsed);
