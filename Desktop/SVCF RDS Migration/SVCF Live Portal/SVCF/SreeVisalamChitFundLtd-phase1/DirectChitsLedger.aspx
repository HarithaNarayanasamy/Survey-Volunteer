<%@ Page Culture="en-GB" Language="C#" MasterPageFile="~/Branch.Master" AutoEventWireup="true"
    CodeBehind="DirectChitsLedger.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.DirectChitsLedger"
                        ...
                        <div style="margin-top: -0.5em; margin-bottom: 0.6em;" class="Sub-heading">
                            ...
                            <div style="display: table-cell; vertical-align: top; padding-top: 4px; padding-right: 5px !important;">
                                <asp:DropDownList ID="ddlGroup" Width="150px" CssClass="chzn-select" AutoPostBack="true"
                                    ...
                                    <asp:ListItem Text="Chit and Date" Value="Chit and Date"></asp:ListItem>
                                    <asp:ListItem Text="Chit and Token" Value="Chit and Token"></asp:ListItem>  
                                    <asp:ListItem Text="Date" Value="Date"></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                            <div style="display: table-cell; vertical-align: top; padding-top: 4px; padding-right: 5px !important;">
                                <asp:CheckBox AutoPostBack="true" runat="server" ID="chkKasar" OnCheckedChanged="chkKasar_OnCheckedChanged"
                                    Text="Load with Chit Kasar" />
                            </div>
                              <div style="display: table-cell; vertical-align: top; padding-top: 10px; padding-right: 5px !important;">
                                <asp:Label ID="Label4" runat="server" Text="Chit: "></asp:Label>
                            </div>
                            <div style="display:table-cell; vertical-align:top; padding-top:10px; padding-right:5px !important;">
                                <asp:DropDownList ID="ddlchit" Width="100px" CssClass="chzn-select" AutoPostBack="true"
                            ...
                            <TabPages>
                                    ...
                                    <ContentCollection>
                                        <dx:ContentControl ID="ContentControl2" runat="server">
                                            <dx:ASPxGridView Styles-AlternatingRow-BackColor="LightGray" Style="margin: 0 auto;
                                                width: 100%;" ID="gridprev" ClientInstanceName="gridprev" runat="server" Settings-ShowColumnHeaders="false" 
                                                ...
                                                <GroupSummary>
                                                    <dx:ASPxSummaryItem FieldName="Credit" SummaryType="Sum" />
                                                    <dx:ASPxSummaryItem FieldName="Debit" SummaryType="Sum" />
                                                    <dx:ASPxSummaryItem FieldName="Token" ShowInGroupFooterColumn="Debit" SummaryType="Custom" />
                                                    <dx:ASPxSummaryItem FieldName="LedgerHead" ShowInGroupFooterColumn="Credit" SummaryType="Custom" />
                                                </GroupSummary>
                                                <SettingsText Title="Chit Ledger" />
                                                ...
                                                <Columns>
                                                    ...
                                                    <dx:GridViewDataColumn FieldName="Narration" Width="100px">
                                                    </dx:GridViewDataColumn>
                                                ...
                                                <Styles>
                                                   <%-- <Header Wrap="True" HorizontalAlign="Center">
                                                    ...
                                                    <Footer HorizontalAlign="Left" Wrap="True">
                                                      ...
                                                      <Cell Font-Size="08" HorizontalAlign="Right" Wrap="True" Paddings-PaddingBottom="3px" Paddings-PaddingRight="3px" >
                                                         </Cell>
                                ...
                                <Title Font-Size="07" VerticalAlign="Middle" HorizontalAlign="Center" Paddings-PaddingBottom="2px" Paddings-PaddingTop="2px">
                                            ...
                                            <dx:ASPxGridView Style="margin: 0 auto; width: 100%;" OnSummaryDisplayText="ASPxGridView1_SummaryDisplayText"
                                                ...
                                                runat="server" OnCustomCallback="grid_CustomCallback">
                                                ...
                                                <SettingsText Title="Chit Ledger" />
                                                <Columns>
                                                    <dx:GridViewDataColumn FieldName="Date" Caption="DATE">
                                                    </dx:GridViewDataColumn>
                                                    <dx:GridViewDataColumn FieldName="Token" Caption="TOKEN">
                                                    </dx:GridViewDataColumn>
                                                    <dx:GridViewDataColumn FieldName="LedgerHead" Caption="CHIT GROUP" Visible="false">
                                                    </dx:GridViewDataColumn>
                                                    <dx:GridViewDataColumn FieldName="Narration" Caption="NARRATION" >
                                                    </dx:GridViewDataColumn>
                                                    <dx:GridViewDataColumn FieldName="Credit" Caption="CREDIT">
                                                    </dx:GridViewDataColumn>
                                                    <dx:GridViewDataColumn FieldName="Debit" Caption="DEBIT">
                                                    </dx:GridViewDataColumn>
                                                </Columns>
                                                <Styles Footer-HorizontalAlign="Left" Cell-HorizontalAlign="Left" Header-VerticalAlign="Middle"
                                                    Header-HorizontalAlign="Center" Header-Wrap="True">
                                            ...
                                            <dx:ASPxGridViewExporter ID="gridExport" runat="server" GridViewID="grid">
                                               <%-- <Styles>
                                                    <Header Font-Size="9" Wrap="True" HorizontalAlign="Center">
                                                    </Header>
