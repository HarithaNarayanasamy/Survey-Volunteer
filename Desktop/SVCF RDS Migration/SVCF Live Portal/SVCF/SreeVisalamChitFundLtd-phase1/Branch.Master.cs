    ...
    public partial class Branch : System.Web.UI.MasterPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //23-10-2020
                DataTable dtCirculars = balayer.GetDataTable("select * from circularuploads where Date='"+DateTime.Now.ToString("yyyy/MM/dd")+"';");
                notyTip.InnerText = dtCirculars.Rows.Count.ToString();
