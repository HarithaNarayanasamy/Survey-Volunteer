<%@ Page Culture="en-GB" Title="SVCF Admin Panel" Language="C#" AutoEventWireup="true"
    CodeBehind="InvestmentLedgerNew.aspx.cs" Inherits="SreeVisalamChitFundLtd_phase1.InvestmentLedgerNew" %>
...
<body>
    ...
    <dx:ASPxGridView Style="margin: 0 auto; width: 100%;" OnSummaryDisplayText="ASPxGridView1_SummaryDisplayText"
        ...
        <Columns>
            ...
            <dx:GridViewDataColumn FieldName="Narration" CellStyle-HorizontalAlign="Left" 
                FooterCellStyle-HorizontalAlign="Left">
            </dx:GridViewDataColumn>
            <dx:GridViewDataColumn FieldName="Credit" GroupFooterCellStyle-HorizontalAlign="Right" FooterCellStyle-HorizontalAlign="Right">
            </dx:GridViewDataColumn>
            <dx:GridViewDataColumn FieldName="Debit" GroupFooterCellStyle-HorizontalAlign="Right" FooterCellStyle-HorizontalAlign="Right">
            </dx:GridViewDataColumn>
        </Columns>
