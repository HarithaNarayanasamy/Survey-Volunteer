                        ...
                        <div style="width:100%; margin: 0 auto;">
                            <dx:ASPxGridView ID="gridBranch"  Style="margin: 0 auto; width: 100%;" ClientInstanceName="grid"
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn FieldName="B_Prefix" Caption="Branch Prefix"/>
                                ...
                                <Templates>
                                    <EditForm>
                                        <table style="width: 100%; margin: 0 auto;">
                                            ...
                                            <tr>
                                                <td style="vertical-align:middle;padding-left:5px;">
                                                    <dx:ASPxLabel Width="100%" ID="lblPrefix" runat="server" Text="Branch Prefix">
                                                    </dx:ASPxLabel>
                                                </td>
                                                <td>
                                                    <dx:ASPxTextBox runat="server" ID="edPrefix" Text='<%# Bind("B_Prefix") %>' Width="100%" 
                                                        ValidationSettings-ValidationGroup="<%# Container.ValidationGroup %>">
                                                        <ValidationSettings Display="Dynamic">
                                                            <RequiredField IsRequired="true"
/>                                                        </ValidationSettings>
